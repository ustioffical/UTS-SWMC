 ...
 */function (t, e) {
 ...
 - ${i}: ${e}`, r && (a += encodeURI(i) + "=" + encodeURI(e))
    ...
    let V = {
            ...
            find: G,
            fireEvent: U,
            getAlignFactor: (t = "") => ({center: .5, right: 1, middle: .5, bottom: 1})[t] || 0,
            ...
            timeUnits: ta,
            ucfirst: tn
        } = V, th = w.isSafari && _.Intl && !_.Intl.DateTimeFormat.prototype.formatRange, tl = t => void 0 === t.main,
        td = class {
            constructor(t, e) {
                this.options = {timezone: "UTC"}, this.variableTimezone = !1, this.Date = _.Date, this.update(t), this.lang = e
            }
            ...
            getTimezoneOffset(t) {
                if ("UTC" !== this.timezone) {
                    let [e, i, s, o, r = 0] = this.dateTimeFormat({timeZoneName: "shortOffset"}, t, "en").split(/(GMT|:)/).map(Number),
                        a = -(60 * (s + r / 60) * 6e4);
                    if (Q(a)) return a
                }
                return 0
            ...
            dateFormat(t, e, i) {
                ...
                if (te(t) && -1 !== t.indexOf("%")) {
                    let i = this, [o, r, a, n, h, l, d, c] = this.toParts(e), p = s?.weekdays || this.weekdays,
                        g = s?.shortWeekdays || this.shortWeekdays, u = s?.months || this.months,
                    ...
                    let i = (this.getTimezoneOffset(e) || 0) / 36e5,
                        s = this.timezone || "Etc/GMT" + (i >= 0 ? "+" : "") + i, {prefix: o = "", suffix: r = ""} = t;
            ...
            resolveDTLFormat(t) {
                return tt(t, !0) ? tt(t, !0) && tl(t) ? {main: t} : t : {main: (t = tr(t))[0], from: t[1], to: t[2]}
            }

            getDateFormat(t, e, i, s) {
                let o = this.dateFormat("%m-%d %H:%M:%S.%L", e), r = "01-01 00:00:00.000",
                    a = {millisecond: 15, second: 12, minute: 9, hour: 6, day: 3}, n = "millisecond", h = n;
                for (n in ta) {
            ...
            getTimeTicks(t, e, i, s) {
                let o = this, r = [], a = {}, {count: n = 1, unitRange: h} = t, [l, d, c, p, g, u] = o.toParts(e),
                    f = (e || 0) % 1e3, m;
                if (s ?? (s = 1), tc(e)) {
            ...
            defaultOptions: ty, defaultTime: tb, getOptions: function () {
                return ty
            }, setOptions: function (t) {
                return tm(w, "setOptions", {options: t}), tx(!0, ty, t), t.time && tb.update(ty.time), t.lang && "locale" in t.lang && tb.update({locale: t.lang.locale}), t.lang?.chartTitle && (ty.title = {
                    ...ty.title,
                    text: t.lang.chartTitle
                }), ty
            }
        }, {win: tk} = w, {isNumber: tw, isString: tM, merge: tS, pInt: tT, defined: tC} = V,
        tA = (t, e, i) => `color-mix(in srgb,${t},${e} ${100 * i}%)`, tP = t => tM(t) && !!t && "none" !== t;
    ...
    class tL {
        ...
        tweenTo(t, e) {
            ...
            let o = 1 !== s[3] || 1 !== i[3], r = (t, s) => t + (i[s] - t) * (1 - e),
    ...
    tL.names = {
        ...
        regex: /^#([a-f0-9])([a-f0-9])([a-f0-9])([a-f0-9])?$/i, parse: function (t) {
            return [tT(t[1] + t[1], 16), tT(t[2] + t[2], 16), tT(t[3] + t[3], 16), tC(t[4]) ? tT(t[4] + t[4], 16) / 255 : 1]
        }
    }, {
        regex: /^#([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})([a-f0-9]{2})?$/i, parse: function (t) {
    ...
    class tB {
        ...
        initPath(t, e, i) {
            let s = t.startX, o = t.endX, r = i.slice(), a = t.isArea, n = a ? 2 : 1,
                h = e && i.length > e.length && i.hasStackedCliffs, l, d, c, p, g = e?.slice();
            if (!g || h) return [r, r];
    ...
    function tj(t) {
        return tH(t) ? tF({duration: 500, defer: 0}, t) : {duration: 500 * !!t, defer: 0}
    }
    ...
    let tU = {
            ...
            }, animObject: tj, getDeferredAnimation: function (t, e, i) {
                let s = tj(e), o = i ? [i] : t.series, r = 0, a = 0;
                return o.forEach(t => {
                    let i = tj(t.options.animation);
                    r = tH(e) && tN(e.defer) ? s.defer : Math.max(r, i.duration + i.defer), a = Math.min(s.duration, i.duration)
                }), t.renderer.forExport && (r = 0), {defer: Math.max(0, r - a), duration: Math.min(r, a)}
    ...
    class t6 {
        static filterUserAttributes(t) {
            return t0(t, (e, i) => {
                let s = !0;
                -1 === t6.allowedAttributes.indexOf(i) && (s = !1), -1 !== ["background", "dynsrc", "href", "lowsrc", "src"].indexOf(i) && (s = tQ(e) && t6.allowedReferences.some(t => 0 === e.indexOf(t))), s || (tK(33, !1, void 0, {"Invalid attribute in config": `${i}`}), delete t[i]), tQ(e) && t[i] && (t[i] = e.replace(/</g, "&lt;"))
            }), t
        }
        ...
        addToDOM(t) {
            return function t(e, i) {
                ...
                return t1(e).forEach(function (e) {
                    let o, r = e.tagName, a = e.textContent ? w.doc.createTextNode(e.textContent) : void 0,
                        n = t6.bypassHTMLFiltering;
                    if (r) if ("#text" === r) o = a; else if (-1 !== t6.allowedTags.indexOf(r) || n) {
                        let s = "svg" === r ? t$ : i.namespaceURI || t$, h = w.doc.createElementNS(s, r),
                            l = e.attributes || {};
                        t0(e, function (t, e) {
    ...
    let {defaultOptions: t9, defaultTime: t4} = tv, {pageLang: t8} = w, {
        extend: t7,
        ...
        each: function (t) {
            ...
            return !!ee(t) && t.map((i, s) => ed(e.body, t7(es(i) ? i : {"@this": i}, {
                "@index": s,
                "@first": 0 === s,
                "@last": s === t.length - 1
            }))).join("")
    ...
    function ed(t = "", e, i) {
        let s = /\{([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'’= #\(\)]+)\}/g,
            o = /\(([a-zA-Z\u00C0-\u017F\d:\.,;\-\/<>\[\]%_@+"'= ]+)\)/g, r = [], a = /f$/, n = /\.(\d)/,
            h = i?.options?.lang || t9.lang, l = i?.time || t4, d = i?.numberFormatter || ec.bind(i), c = (t = "") => {
                let i;
        ...
        for (; null !== (p = s.exec(t));) {
            ...
            let n = "else" === p[1];
            if (g.isBlock && g.fn && (p[1] === `/${g.fn}` || n)) if (u) !n && u--; else {
        ...
        return r.forEach(s => {
            ...
            if (m) {
                ...
                let t = el(f) ? [f] : f.split(":"), e = (r = c(t.shift() || "")) % 1 != 0;
    ...
    function ec(t, e, i, s) {
        e *= 1;
        let o, r, [a, n] = (t = +t || 0).toString().split("e").map(Number), h = this?.options?.lang || t9.lang,
            l = (t.toString().split(".")[1] || "").split("e")[0].length, d = e, c = {};
    ...
    (o || (o = {})).distribute = function t(e, i, s) {
        let o = e, r = o.reducedLen || i, a = (t, e) => t.target - e.target, n = [], h = e.length, l = [], d = n.push,
            c, p, g, u = !0, f, m, x = 0, y;
        ...
        for (ex(e, a), e = e.map(t => ({size: t.size, targets: [t.target], align: ef(t.align, .5)})); u;) {
    ...
    class eK {
        ...
        align(t, e, i, s = !0) {
            ...
            let h = eU(i, o[n], o), l = (h.x || 0) + (t.x || 0) + ((h.width || 0) - (t.width || 0)) * eR(t.align),
        ...
        clip(t) {
            if (t && !t.clipPath) {
                let e = eq() + "-", i = this.renderer.createElement("clipPath").attr({id: e}).add(this.renderer.defs);
        ...
        crisp(t, e) {
            ...
            let i = t.x || this.x || 0, s = t.y || this.y || 0, o = (t.width || this.width || 0) + i,
                r = (t.height || this.height || 0) + s, a = eE(i, e), n = eE(s, e);
            return eN(t, {
                x: a,
                y: n,
                width: eE(o, e) - a,
        ...
        complexColor(t, e, i) {
            ...
            ez(this.renderer, "complexColor", {args: arguments}, function () {
                if (t.radialGradient ? r = "radialGradient" : t.linearGradient && (r = "linearGradient"), r) {
                    ...
                    }), "radialGradient" === r && p && !eD(a.gradientUnits) && (n = a, a = ej(a, s.getRadialAttr(p, n), {gradientUnits: "userSpaceOnUse"})), eY(a, function (t, e) {
                        "id" !== e && u.push(e, t)
                    }), eY(l, function (t) {
                        u.push(t)
        ...
        getBBox(t, e) {
            let i, s, o, r, {alignValue: a, element: n, renderer: h, styles: l, textStr: d} = this, {
                    cache: c,
                    cacheKeys: p
                } = h, g = n.namespaceURI === this.SVG_NS, u = eU(e, this.rotation, 0),
        ...
        getRotatedBox(t, e) {
            let {x: i, y: s, width: o, height: r} = t, {
                    ...
                    rotationOriginX: h = 0,
                    rotationOriginY: l = 0
                } = this, d = eR(a), c = Number(this.element.getAttribute("y") || 0) - (n ? 0 : s), p = e * ew,
                g = (e - 90) * ew, u = Math.cos(p), f = Math.sin(p), m = o * u, x = o * f, y = Math.cos(g),
                b = Math.sin(g), [[v, k], [w, M]] = [h, l].map(t => [t - t * u, t * f]),
                S = i + d * (o - m) + v + M + c * y, T = S + m, C = T - r * y, A = C - m,
                P = s + c - d * x - k + w + c * b, L = P + x, O = L - r * b, E = O - x, I = Math.min(S, T, C, A),
                D = Math.min(P, L, O, E), B = Math.max(S, T, C, A) - I, N = Math.max(P, L, O, E) - D;
            return {x: I, y: D, width: B, height: N, polygon: [[S, P], [T, L], [C, O], [A, E]]}
        }
        ...
        shadow(t) {
            let {renderer: e} = this,
                i = ej(this.parentGroup?.rotation === 90 ? {offsetX: -1, offsetY: -1} : {}, eX(t) ? t : {}),
        ...
        zIndexSetter(t, e) {
            let i = this.renderer, s = this.parentGroup, o = (s || i).element || i.box, r = this.element,
                a = o === i.box, n, h, l, d = !1, c, p = this.added, g;
    ...
    class e9 extends eJ {
        constructor(t, e, i, s, o, r, a, n, h, l) {
            let d;
            super(t, "g"), this.paddingLeftSetter = this.paddingSetter, this.paddingRightSetter = this.paddingSetter, this.doUpdate = !1, this.textStr = e, this.x = i, this.y = s, this.anchorX = r, this.anchorY = a, this.baseline = h, this.className = l, this.addClass("button" === l ? "highcharts-no-tooltip" : "highcharts-label"), l && this.addClass("highcharts-" + l), this.text = t.text(void 0, 0, 0, n).attr({zIndex: 1}), "string" == typeof o && ((d = /^url\((.*?)\)$/.test(o)) || this.renderer.symbols[o]) && (this.symbolKey = o), this.bBox = e9.emptyBBox, this.padding = 3, this.baselineOffset = 0, this.needsBox = t.styledMode || d, this.deferredAttr = {}, this.alignFactor = 0
        }

        alignSetter(t) {
            let e = e1(t);
            this.textAlign = t, e !== this.alignFactor && (this.alignFactor = e, this.bBox && e2(this.xSetting) && this.attr({x: this.xSetting}))
        }
        ...
        getBBox(t, e) {
            ...
            let {padding: i, height: s = 0, translateX: o = 0, translateY: r = 0, width: a = 0} = this,
                n = e5(this.paddingLeft, i), h = e ?? (this.rotation || 0),
        ...
        onAdd() {
            this.text.add(this), this.attr({
                ...
                x: this.x || 0,
                y: this.y || 0
            }), this.box && eQ(this.anchorX) && this.attr({anchorX: this.anchorX, anchorY: this.anchorY})
        }
        ...
        updateBoxSize() {
            let t, e = this.text, i = {}, s = this.padding,
    ...
    function it(t, e, i, s, o) {
        let r = [];
        if (o) {
            let a = o.start || 0, n = o.end || 0, h = e7(o.r, i), l = e7(o.r, s || i),
                d = 2e-4 / (o.borderRadius ? 1 : Math.max(h, 1)), c = Math.abs(n - a - 2 * Math.PI) < d;
            c && (a = Math.PI / 2, n = 2.5 * Math.PI - d);
            let p = o.innerR, g = e7(o.open, c), u = Math.cos(a), f = Math.sin(a), m = Math.cos(n), x = Math.sin(n),
    ...
    let is = {
        arc: it, callout: function (t, e, i, s, o) {
            let r = Math.min(o?.r || 0, i, s), a = r + 6, n = o?.anchorX, h = o?.anchorY || 0, l = ii(t, e, i, s, {r});
            if (!e8(n) || n < i && n > 0 && h < s && h > 0) return l;
            if (t + n > i - a) if (h > e + a && h < e + s - a) l.splice(3, 1, ["L", t + i, h - 6], ["L", t + i + 6, h], ["L", t + i, h + 6], ["L", t + i, e + s - r]); else if (n < i) {
                let o = h < e + a, d = o ? e : e + s;
                l.splice(o ? 2 : 5, 0, ["L", n, h], ["L", t + i - r, d])
            } else l.splice(3, 1, ["L", t + i, s / 2], ["L", n, h], ["L", t + i, s / 2], ["L", t + i, e + s - r]); else if (t + n < a) if (h > e + a && h < e + s - a) l.splice(7, 1, ["L", t, h + 6], ["L", t - 6, h], ["L", t, h - 6], ["L", t, e + r]); else if (n > 0) {
                let i = h < e + a, o = i ? e : e + s;
                l.splice(i ? 1 : 6, 0, ["L", n, h], ["L", t + r, o])
            } else l.splice(7, 1, ["L", t, s / 2], ["L", n, h], ["L", t, s / 2], ["L", t, e + r]); else h > s && n < i - a ? l.splice(5, 1, ["L", n + 6, e + s], ["L", n, e + s + 6], ["L", n - 6, e + s], ["L", t + r, e + s]) : h < 0 && n > a && l.splice(1, 1, ["L", n - 6, e], ["L", n, e - 6], ["L", n + 6, e], ["L", i - r, e]);
            return l
        }, circle: function (t, e, i, s) {
            return it(t + i / 2, e + s / 2, i / 2, s / 2, {start: .5 * Math.PI, end: 2.5 * Math.PI, open: !1})
        }, diamond: function (t, e, i, s) {
            return [["M", t + i / 2, e], ["L", t + i, e + s / 2], ["L", t + i / 2, e + s], ["L", t, e + s / 2], ["Z"]]
        }, rect: ie, roundedRect: ii, square: ie, triangle: function (t, e, i, s) {
        ...
        objectEach: ip,
        pick: ig
    } = V, iu = (t, e) => t.substring(0, e) + "…", im = class {
        constructor(t) {
            let e = t.styles;
        ...
        buildSVG() {
            let t = this.svgElement, e = t.element, i = t.renderer, s = ig(t.textStr, "").toString(),
                o = -1 !== s.indexOf("<"), r = e.childNodes, a = !t.added && i.box,
        ...
        modifyDOM() {
            ...
            if (!s) return;
            let o = (t, o) => {
                let r = t.textContent || "", a = r.replace(/([^\^])-/g, "$1- ").split(" "),
                    n = !this.noWrap && (a.length > 1 || e.element.childNodes.length > 1), h = this.getLineHeight(o),
                    l = Math.max(0, s - .8 * h), d = 0, c = e.actualWidth;
                if (n) {
                    let r = [], n = [];
        ...
        truncate(t, e, i, s, o, r, a) {
            let n, h, l = this.svgElement, {rotation: d} = l, c = [], p = i && !s ? 1 : 0, g = (e || i || "").length,
                u = g;
            i || (o = r);
            let f = function (e, o) {
    ...
    class iU {
        constructor(t, e, i, s, o, r, a) {
            ...
            a || l.css(this.getStyle(s || {})), t.appendChild(d), iL(t, "dir", "ltr"), -1 === t.innerHTML.indexOf("xmlns") && iL(d, "xmlns", this.SVG_NS), this.box = d, this.boxWrapper = l, this.alignedObjects = [], this.url = this.getReferenceURL(), this.createElement("desc").add().element.appendChild(iv.createTextNode("Created with Highcharts 12.3.0")), this.defs = this.createElement("defs").add(), this.allowHTML = r, this.forExport = o, this.styledMode = a, this.gradients = {}, this.cache = {}, this.cacheKeys = [], this.imgCount = 0, this.rootFontSize = l.getStyle("font-size"), this.setSize(e, i, !1), ik && t.getBoundingClientRect && ((n = function () {
                iI(t, {left: 0, top: 0}), h = t.getBoundingClientRect(), iI(t, {
        ...
        shadowDefinition(t) {
            let e = [`highcharts-drop-shadow-${this.chartIndex}`, ...Object.keys(t).map(e => `${e}-${t[e]}`)].join("-").toLowerCase().replace(/[^a-z\d\-]/g, ""),
                i = iF({color: "#000000", offsetX: 1, offsetY: 1, opacity: .15, width: 5}, t);
        ...
        button(t, e, i, s, o = {}, r, a, n, h, l) {
            let d = this.label(t, e, i, h, void 0, void 0, l, void 0, "button"), c = this.styledMode, p = arguments,
                g = 0;
            ...
            let m = [t6.filterUserAttributes(o)], x = [f];
            ...
            }, d.attr(m[0]), !c && (d.css(iN({cursor: "default"}, f)), l && d.text.css({pointerEvents: "none"})), d.on("touchstart", t => t.stopPropagation()).on("click", function (t) {
                3 !== g && s?.call(d, t)
            })
        }
        ...
        circle(t, e, i) {
            let s = iW(t) ? t : void 0 === t ? {} : {x: t, y: e, r: i}, o = this.createElement("circle");
        ...
        symbol(t, e, i, s, o, r) {
            let a, n, h, l, d = this, c = /^url\((.*?)\)$/, p = c.test(t), g = !p && (this.symbols[t] ? t : "circle"),
                u = g && this.symbols[g];
        ...
        fontMetrics(t) {
            let e = iG(eJ.prototype.getStyle.call(t, "font-size") || 0), i = e < 24 ? e + 3 : Math.round(1.2 * e),
                s = Math.round(.8 * i);
            return {h: i, b: s, f: e}
        }
        ...
        rotCorr(t, e, i) {
            let s = t;
            return e && i && (s = Math.max(s * Math.cos(e * ib), 4)), {x: -t / 3 * Math.sin(e * ib), y: s}
        }
    ...
    let i5 = (t, e) => {
        if (!t.div) {
            let i = iZ(t.element, "class"), s = t.css, o = iq("div", i ? {className: i} : void 0, {
                position: "absolute",
    ...
    class i6 extends eJ {
        ...
        constructor(t, e) {
            super(t, e), i6.useForeignObject ? this.foreignObject = t.createElement("foreignObject").attr({zIndex: 2}) : this.css({
        ...
        updateTransform() {
            ...
            if (e || i_(t, {marginLeft: `${g}px`, marginTop: `${u}px`}), "SPAN" === t.tagName) {
                ...
                e && (i_(t, {display: "inline-block", verticalAlign: "top"}), e.attr({
                    width: s.width,
                    height: s.height
                ...
                }), i_(t, {display: l, textAlign: c})) : iV && e.attr({
                    width: 0,
                    height: 0
        ...
        add(t) {
            ...
            if (e) e.add(t), super.add(i.createElement("body").attr({xmlns: "http://www.w3.org/1999/xhtml"}).css({
    ...
    (a || (a = {})).registerEventOptions = function (t, e) {
        t.eventOptions = t.eventOptions || {}, st(e.events, function (e, i) {
            t.eventOptions[i] !== e && (t.eventOptions[i] && (se(t, i, t.eventOptions[i]), delete t.eventOptions[i]), i7(e) && (t.eventOptions[i] = e, i8(t, i, e, {order: 0})))
        })
    };
    let si = a, {deg2rad: ss} = w, {
            clamp: so,
            correctFloat: sr,
            defined: sa,
            ...
            addLabel() {
                let t = this, e = t.axis, i = e.options, s = e.chart, o = e.categories, r = e.logarithmic, a = e.names,
                    n = t.pos, h = su(t.options?.labels, i.labels), l = e.tickPositions, d = n === l[0],
                    c = n === l[l.length - 1], p = (!h.step || 1 === h.step) && 1 === e.tickInterval, g = l.info,
                    u = t.label, f, m, x, y = this.parameters.category || (o ? su(o[n], a[n], n) : n);
                ...
                let v = t => h.formatter ? h.formatter.call(t, t) : h.format ? (t.text = e.defaultLabelFormatter.call(t), ep.format(h.format, t, s)) : e.defaultLabelFormatter.call(t),
                    k = v.call(b, b), w = m?.list;
                w ? t.shortenLabel = function () {
                    for (x = 0; x < w.length; x++) if (sh(b, {dateTimeLabelFormat: w[x]}), u.attr({text: v.call(b, b)}), u.getBBox().width < e.getSlotWidth(t) - 2 * (h.padding || 0)) return;
                    u.attr({text: ""})
                } : t.shortenLabel = void 0, p && e._addedPlotLB && t.moveLabel(k, h), sa(u) || t.movedLabel ? u && u.textStr !== k && !p && (!u.textWidth || h.style.width || u.styles.width || u.css({width: null}), u.attr({text: k}), u.textPxLength = u.getBBox().width) : (t.label = u = t.createLabel(k, h), t.rotation = 0)
            }

            createLabel(t, e, i) {
                let s = this.axis, {renderer: o, styledMode: r} = s.chart, a = e.style.whiteSpace,
                    n = sa(t) && e.enabled ? o.text(t, i?.x, i?.y, e.useHTML).add(s.labelGroup) : void 0;
                return n && (r || n.css(sp(e.style)), n.textPxLength = n.getBBox().width, !r && a && n.css({whiteSpace: a})), n
            }
            ...
            getLabelPosition(t, e, i, s, o, r, a, n) {
                let h, l, d = this.axis, c = d.transA,
                    p = d.isLinked && d.linkedParent ? d.linkedParent.reversed : d.reversed, g = d.staggerLines,
            ...
            handleOverflow(t) {
                let e = this.axis, i = e.options.labels, s = t.x, o = e.chart.chartWidth, r = e.chart.spacing,
                    a = su(e.labelLeft, Math.min(e.pos, r[3])),
                    n = su(e.labelRight, Math.max(e.isRadial ? 0 : e.pos + e.len, o - r[1])), h = this.label,
                    l = this.rotation, d = sd(e.labelAlign || h.attr("align")), c = h.getBBox().width,
                    p = e.getSlotWidth(this), g = p, u = 1, f;
            ...
            render(t, e, i) {
                let s = this.axis, o = s.horiz, r = this.pos, a = su(this.tickmarkOffset, s.tickmarkOffset),
                    n = this.getPosition(o, r, a, e), h = n.x, l = n.y, d = s.pos, c = d + s.len, p = o ? h : l,
            ...
            renderGridLine(t, e) {
                let i = this.axis, s = i.options, o = {}, r = this.pos, a = this.type,
                    n = su(this.tickmarkOffset, i.tickmarkOffset), h = i.chart.renderer, l = this.gridLine, d,
            ...
            renderMark(t, e) {
                let i = this.axis, s = i.options, o = i.chart.renderer, r = this.type,
                    a = i.tickSize(r ? r + "Tick" : "tick"), n = t.x, h = t.y,
            ...
            renderLabel(t, e, i, s) {
                let o = this.axis, r = o.horiz, a = o.options, n = this.label, h = a.labels, l = h.step,
                    d = su(this.tickmarkOffset, o.tickmarkOffset), c = t.x, p = t.y, g = !0;
            ...
            xAxis: sx,
            yAxis: sy
        } = i4, {defaultOptions: sb} = tv, {registerEventOptions: sv} = si, {deg2rad: sk} = w, {
            arrayMax: sw,
            arrayMin: sM,
            clamp: sS,
            correctFloat: sT,
    ...
    class s$ {
        ...
        init(t, e, i = this.coll) {
            ...
            this.chart = t, this.horiz = o, this.isXAxis = s, this.coll = i, sE(this, "init", {userOptions: e}), this.opposite = sF(e.opposite, this.opposite), this.side = sF(e.side, this.side, o ? 2 * !this.opposite : this.opposite ? 1 : 3), this.setOptions(e);
        ...
        setOptions(t) {
            let e = this.horiz ? {labels: {autoRotation: [-45], padding: 3}, margin: 15} : {
                labels: {padding: 1},
                title: {rotation: 90 * this.side}
            };
            this.options = sR(e, "yAxis" === this.coll ? {title: {text: this.chart.options.lang.yAxisTitle}} : {}, sb[this.coll], t), sE(this, "afterSetOptions", {userOptions: t})
        }

        defaultLabelFormatter() {
            let t = this.axis, {numberFormatter: e} = this.chart, i = sN(this.value) ? this.value : NaN,
                s = t.chart.time, o = t.categories, r = this.dateTimeLabelFormat, a = sb.lang, n = a.numericSymbols,
                h = a.numericSymbolMagnitude || 1e3, l = t.logarithmic ? Math.abs(i) : t.tickInterval, d = n?.length, c,
                p;
        ...
        translate(t, e, i, s, o, r) {
            ...
            if (!sN(n)) return NaN;
            let h = a.minPixelPadding, l = (a.isOrdinal || a.brokenAxis?.hasBreaks || a.logarithmic && o) && a.lin2val,
                d = 1, c = 0, p = s && a.old ? a.old.transA : a.transA, g = 0;
        ...
        getPlotLinePath(t) {
            let e = this, i = e.chart, s = e.left, o = e.top, r = t.old, a = t.value, n = t.lineWidth,
                ...
                c = t.translatedValue, p = t.force, g, u, f, m, x;
            ...
            return sE(this, "getPlotLinePath", b, function (t) {
                g = f = (c = sS(c = sF(c, e.translate(a, void 0, void 0, r)), -1e9, 1e9)) + d, u = m = h - c - d, sN(c) ? e.horiz ? (u = o, m = h - e.bottom + (e.options.isInternal ? 0 : i.scrollablePixelsY || 0), g = f = y(g, s, s + e.width)) : (g = s, f = l - e.right + (i.scrollablePixelsX || 0), u = m = y(u, o, o + e.height)) : (x = !0, p = !1), t.path = x && !p ? void 0 : i.renderer.crispLine([["M", g, u], ["L", f, m]], n || 1)
            }), b.path
        }
        ...
        getMinorTickPositions() {
            let t = this.options, e = this.tickPositions, i = this.minorTickInterval, s = this.pointRangePadding || 0,
                o = (this.min || 0) - s, r = (this.max || 0) + s,
                a = this.brokenAxis?.hasBreaks ? this.brokenAxis.unitLength : r - o, n = [], h;
            if (a && a / i < this.len / 3) {
        ...
        adjustForMinRange() {
            let t = this.options, e = this.logarithmic, i = this.chart.time, {max: s, min: o, minRange: r} = this, a, n,
                h, l;
        ...
        setAxisTranslation() {
            let t = this, e = t.max - t.min, i = t.linkedParent, s = !!t.categories, o = t.isXAxis,
                r = t.axisPointRange || 0, a, n = 0, h = 0, l, d = t.transA;
        ...
        setTickInterval(t) {
            let {
                    ...
                    options: h,
                    softThreshold: l
                } = this, d = i.time, c = sN(this.threshold) ? this.threshold : void 0, p = this.minRange || 0, {
                    ceiling: g,
                    floor: u,
                    linkedTo: f,
                    softMax: m,
                    softMin: x
                } = h, y = sN(f) && i[this.coll]?.[f], b = h.tickPixelInterval, v = h.maxPadding, k = h.minPadding, w = 0,
                M, S = sN(h.tickInterval) && h.tickInterval >= 0 ? h.tickInterval : void 0, T, C, A, P;
        ...
        setTickPositions() {
            let t = this.options, e = t.tickPositions, i = t.tickPositioner, s = this.getMinorTickInterval(),
                o = !this.isPanning, r = o && t.startOnTick, a = o && t.endOnTick, n = [], h;
        ...
        alignToOthers() {
            let t, e = this, i = e.chart, s = [this], o = e.options, r = i.options.chart,
        ...
        adjustTickAmount() {
            let t = this, {
                ...
                } = t, h = r?.length, l = sF(t.threshold, t.softThreshold ? 0 : null), d, c, p = t.tickInterval, g,
                u = () => r.push(sT(r[r.length - 1] + p)), f = () => r.unshift(sT(r[0] - p));
        ...
        setExtremes(t, e, i = !0, s, o) {
            ...
            this.series.forEach(t => {
                delete t.kdTree
            }), t = r.time.parse(t), e = r.time.parse(e), sE(this, "setExtremes", o = sO(o, {min: t, max: e}), t => {
        ...
        autoLabelAlign(t) {
            let e = (sF(t, 0) - 90 * this.side + 720) % 360, i = {align: "center"};
        ...
        unsquish() {
            let t = this.options.labels, e = t.padding || 0, i = this.horiz, s = this.tickInterval,
                o = this.len / ((+!!this.categories + this.max - this.min) / s), r = t.rotation,
                a = sT(.8 * this.labelMetrics().h), n = Math.max(this.max - this.min, 0), h = function (t) {
                    let i = (t + 2 * e) / (o || 1);
        ...
        getSlotWidth(t) {
            let e = this.chart, i = this.horiz, s = this.options.labels,
                o = Math.max(this.tickPositions.length - !this.categories, 1), r = e.margin[3];
        ...
        renderUnsquish() {
            let t = this.chart, e = t.renderer, i = this.tickPositions, s = this.ticks, o = this.options.labels,
                ...
                h = Math.max(1, Math.round(n - (a ? 2 * (o.padding || 0) : o.distance || 0))), l = {},
                d = this.labelMetrics(), c = r.lineClamp, p, g = c ?? (Math.floor(this.len / (i.length * d.h)) || 1),
                u = 0;
            sz(o.rotation) || (l.rotation = o.rotation || 0), i.forEach(function (t) {
                ...
                i && (i.attr(l), e.shortenLabel ? e.shortenLabel() : p && !o && "nowrap" !== r.whiteSpace && (p < (i.textPxLength || 0) || "SPAN" === i.element.tagName) ? i.css(sO(a, {
                    width: `${p}px`,
                    lineClamp: g
                })) : !i.styles.width || a.width || o || i.css({width: "auto"}), e.rotation = l.rotation)
        ...
        addTitle(t) {
            let e, i = this.chart.renderer, s = this.horiz, o = this.opposite, r = this.options.title,
            ...
            this.axisTitle || ((e = r.textAlign) || (e = (s ? {
                ...
                align: e
            }).addClass("highcharts-axis-title"), a || this.axisTitle.css(sR(r.style)), this.axisTitle.add(this.axisGroup), this.axisTitle.isNew = !0), a || r.style.width || this.isRadial || this.axisTitle.css({width: this.len + "px"}), this.axisTitle[t ? "show" : "hide"](t)
        }
        ...
        getOffset() {
            let t = this, {chart: e, horiz: i, options: s, side: o, ticks: r, tickPositions: a, coll: n} = t,
                ...
                p = sN(s.crossing), g = e.axisOffset, u = e.clipOffset, f = [-1, 1, 1, -1][o], m, x = 0, y, b = 0,
                v = 0, k, w;
        ...
        getLinePath(t) {
            let e = this.chart, i = this.opposite, s = this.offset, o = this.horiz,
                r = this.left + (i ? this.width : 0) + s, a = e.chartHeight - this.bottom - (i ? this.height : 0) + s;
        ...
        getTitlePosition(t) {
            let e = this.horiz, i = this.left, s = this.top, o = this.len, r = this.options.title, a = e ? i : s,
                n = this.opposite, h = this.offset, l = r.x, d = r.y, c = this.chart.renderer.fontMetrics(t),
        ...
        render() {
            let t, e, i = this, s = i.chart, o = i.logarithmic, r = s.renderer, a = i.options, n = i.isLinked,
                h = i.tickPositions, l = i.axisTitle, d = i.ticks, c = i.minorTicks, p = i.alternateBands,
                g = a.stackLabels, u = a.alternateGridColor, f = a.crossing, m = i.tickmarkOffset, x = i.axisLine,
                y = i.showAxis, b = sm(r.globalAnimation);
            ...
            }), x && (x[x.isPlaced ? "animate" : "attr"]({d: this.getLinePath(x.strokeWidth())}), x.isPlaced = !0, x[y ? "show" : "hide"](y)), l && y && (l[l.isNew ? "attr" : "animate"](i.getTitlePosition(l)), l.isNew = !1), g?.enabled && i.stacking && i.stacking.renderStackTotals(), i.old = {
                len: i.len,
                max: i.max,
                min: i.min,
                transA: i.transA,
        ...
        destroy(t) {
            ...
            if (sE(this, "destroy", {keepEvents: t}), t || sG(e), [e.ticks, e.minorTicks, e.alternateBands].forEach(function (t) {
                sA(t)
            }), i) {
                let t = i.length;
                for (; t--;) i[t].destroy()
        ...
        drawCrosshair(t, e) {
            ...
            if (sE(this, "drawCrosshair", {e: t, point: e}), t || (t = this.cross?.e), i && !1 !== (sC(e) || !s)) {
                ...
                n = this.categories && !this.isRadial, h || (this.cross = h = o.renderer.path().addClass("highcharts-crosshair highcharts-crosshair-" + (n ? "category " : "thin ") + (i.className || "")).attr({zIndex: sF(i.zIndex, 2)}).add(), !o.styledMode && (h.attr({
                    stroke: i.color || (n ? tL.parse("#ccd3ff").setOpacity(.25).get() : "#cccccc"),
                    "stroke-width": sF(i.width, 1)
                }).css({"pointer-events": "none"}), i.dashStyle && h.attr({dashstyle: i.dashStyle}))), h.show().attr({d: r}), n && !i.width && h.attr({"stroke-width": this.transA}), this.cross.e = t
        ...
        class s {
            ...
            getLogTickPositions(t, e, i, s) {
                ...
                if (s || (this.minorAutoInterval = void 0), t >= .5) t = Math.round(t), n = o.getLinearTickPositions(t, e, i); else if (t >= .08) {
                    ...
                    let h = this.lin2log(e), l = this.lin2log(i), d = s ? o.getMinorTickInterval() : a.tickInterval,
                        c = a.tickPixelInterval / (s ? 5 : 1), p = s ? r / o.tickPositions.length : r;
    ...
    !function (t) {
        ...
        function r(t, e, i) {
            ...
            let s = this.getPlotLinePath({value: e, force: !0, acrossPanes: i.acrossPanes}), o = [], r = this.horiz,
                ...
                n = this.getPlotLinePath({value: t, force: !0, acrossPanes: i.acrossPanes}), h, l = 1, d;
    ...
    class oa {
        ...
        render() {
            ...
            let {axis: t, options: e} = this, {horiz: i, logarithmic: s} = t, {
                    ...
                    events: r,
                    zIndex: a = 0
                } = e, {renderer: n, time: h} = t.chart, l = {}, d = h.parse(e.to), c = h.parse(e.from),
                p = h.parse(e.value), g = e.borderWidth, u = e.label, {label: f, svgElem: m} = this, x = [], y,
                b = s7(c) && s7(d), v = s7(p), k = !m,
            ...
            }), this.eventsAdded = !0), (k || !m.d) && x?.length ? m.attr({d: x}) : m && (x ? (m.show(), m.animate({d: x})) : m.d && (m.hide(), f && (this.label = f = f.destroy()))), u && (s7(u.text) || s7(u.formatter)) && x?.length && t.width > 0 && t.height > 0 && !x.isFlat ? (u = os({
                align: i && b ? "center" : void 0,
                x: i ? !b && 4 : 10,
                verticalAlign: !i && b ? "middle" : void 0,
                y: i ? b ? 16 : 10 : b ? 6 : -4,
                rotation: i && !b ? 90 : 0, ...b ? {inside: !0} : {}
        ...
        renderLabel(t, e, i, s) {
            ...
            let h = e.xBounds || [e[0][1], e[1][1], i ? e[2][1] : e[0][1]],
                l = e.yBounds || [e[0][2], e[1][2], i ? e[2][2] : e[0][2]], d = s8(h), c = s8(l), p = s4(h) - d;
            n.align(t, !1, {
                x: d,
                y: c,
                width: p,
                height: s4(l) - c
            }), n.alignAttr.y -= r.fontMetrics(n).b, (!n.alignValue || "left" === n.alignValue || s7(a)) && n.css({width: (t.style?.width || (i && a ? p : 90 === n.rotation ? o.height - (n.alignAttr.y - o.top) : (t.clip ? o.width : o.chart.chartWidth) - (n.alignAttr.x - o.left))) + "px"}), n.show(!0)
        }
    ...
    let {animObject: on} = tU, {format: oh} = ep, {
        composed: ol,
        dateFormats: od,
        doc: oc,
        isSafari: op
    ...
    class oO {
        ...
        getLabel({anchorX: t, anchorY: e} = {anchorX: 0, anchorY: 0}) {
            let i = this, s = this.chart.styledMode, o = this.options, r = this.split && this.allowShared,
                a = this.container, n = this.chart.renderer;
            if (this.label) {
        ...
        getPosition(t, e, i) {
            let {distance: s, chart: o, outside: r, pointer: a} = this, {
                    ...
                    plotTop: l,
                    polar: d
                } = o, {plotX: c = 0, plotY: p = 0} = i, g = {}, u = n && i.h || 0, {
                    height: f,
                    width: m
            ...
            let T = !this.followPointer && oC(i.ttBelow, !d && !n === S), C = function (t, e, i, o, a, n, h) {
                let l = r ? "y" === t ? b(s) : y(s) : s, d = (i - o) / 2, c = o < a - s, p = a + s + o < e,
                    f = a - l - i + d, m = a + l - d;
        ...
        getFixedPosition(t, e, i) {
            let s = i.series, {chart: o, options: r, split: a} = this, n = r.position, h = n.relativeTo,
        ...
        move(t, e, i, s) {
            let {followPointer: o, options: r} = this, a = on(!o && !this.isHidden && !r.fixed && r.animation),
                n = o || (this.len || 0) > 1, h = {x: t, y: e};
            n ? h.anchorX = h.anchorY = NaN : (h.anchorX = i, h.anchorY = s), a.step = () => this.drawTracker(), this.getLabel().animate(h, a)
        }

        refresh(t, e) {
            let {chart: i, options: s, pointer: o, shared: r} = this, a = oP(t), n = a[0], h = s.format,
                l = s.formatter || this.defaultFormatter, d = i.styledMode, c = this.allowShared;
            ...
            if (this.distance = oC(m.tooltipOptions.distance, 16), !1 === f) this.hide(); else {
                if (this.split && this.allowShared) this.renderSplit(f, a); else {
                    ...
                    if (e && o.isDirectTouch && (t = e.chartX - i.plotLeft, r = e.chartY - i.plotTop), !(i.polar || !1 === m.options.clip || a.some(e => o.isDirectTouch || e.series.shouldShowTooltip(t, r)))) return void this.hide();
                    {
                        ...
                        (!s.style.width || d) && t.css({width: (this.outside ? this.getPlayingField() : i.spacingBox).width + "px"}), t.attr({
                            class: this.getClassName(n),
                            text: f && f.join ? f.join("") : f
                        }), this.outside && t.attr({x: of(t.x || 0, 0, this.getPlayingField().width - (t.width || 0) - 1)}), d || t.attr({stroke: s.borderColor || n.color || m.color || "#666666"}), this.updatePosition({
                            plotX: g,
                            plotY: u,
                            negative: n.negative,
                            ttBelow: n.ttBelow,
        ...
        renderSplit(t, e) {
            let i = this, {
                    ...
                    pointer: x
                } = i, {scrollLeft: y = 0, scrollTop: b = 0} = s.scrollablePlotArea?.scrollingContainer || {},
                v = i.outside && "number" != typeof d ? oc.documentElement.getBoundingClientRect() : {
                    left: y,
                    right: y + o,
                    top: b,
                    bottom: b + r
                }, k = i.getLabel(), w = this.renderer || s.renderer, M = !!s.xAxis[0]?.opposite, {
                    left: S,
                    top: T
                } = x.getChartPosition(), C = m || u, A = h + b, P = 0, L = a - l,
            ...
            let E = t.slice(0, e.length + 1).reduce(function (t, s, o) {
                if (!1 !== s && "" !== s) {
                    let r = e[o - 1] || {isHeader: !0, plotX: e[0].plotX, plotY: a, series: {}}, l = r.isHeader,
                        d = l ? i : r.series, f = d.tt = function (t, e, s) {
                            ...
                            return o.isActive = !0, o.attr({text: s}), c || o.css(n.style).attr({stroke: n.borderColor || e.color || a.color || "#333333"}), o
                    ...
                    let {anchorX: b, anchorY: S} = function (t) {
                        ...
                        if (s) e = Math.max(n + o, n), i = h + a / 2; else {
                            ...
                            e = t.pos + of(o, -p, t.len + p), l.shouldShowTooltip(0, s.pos - h + r, {ignoreX: !0}) && (i = s.pos + r)
                        }
                        return {anchorX: e = of(e, v.left - p, v.right + p), anchorY: i}
                    }(r);
                    if ("number" == typeof S) {
                        let e = x.height + 1, s = (m || O).call(i, y, e, r, [b, S]);
                        t.push({
                            align: C ? 0 : void 0,
                            anchorX: b,
                            anchorY: S,
            ...
            op && k.attr({opacity: 1 === k.opacity ? .999 : 1})
        }
        ...
        headerFooterFormatter(t, e) {
            let i = t.series, s = i.tooltipOptions, o = i.xAxis, r = o?.dateTime, a = {isFooter: e, point: t},
        ...
        updatePosition(t) {
            let {chart: e, container: i, distance: s, options: o, pointer: r, renderer: a} = this, {
                    height: n = 0,
                    width: h = 0
                } = this.getLabel(), {fixed: l, positioner: d} = o, {
                    left: c,
                    top: p,
                    scaleX: g,
                    scaleY: u
                } = r.getChartPosition(), f = (d || l && this.getFixedPosition || this.getPosition).call(this, h, n, t),
                m = w.doc, x = (t.plotX || 0) + e.plotLeft, y = (t.plotY || 0) + e.plotTop, b;
            if (a && i) {
                if (d || l) {
                    let {scrollLeft: t = 0, scrollTop: i = 0} = e.scrollablePlotArea?.scrollingContainer || {};
                    f.x += t + c - s, f.y += i + p - s
                }
                b = (o.borderWidth || 0) + 2 * s + 2, a.setSize(of(h + b, 0, m.documentElement.clientWidth) - 1, n + b, !1), (1 !== g || 1 !== u) && (om(i, {transform: `scale(${g}, ${u})`}), x *= g, y *= u), x += c - f.x, y += p - f.y
            }
    ...
    let oE = oO, {animObject: oI} = tU, {defaultOptions: oD} = tv, {format: oB} = ep, {
        addEvent: oN,
        crisp: oz,
        erase: oR,
        extend: oW,
    ...
    class oq {
        animateBeforeDestroy() {
            ...
            i.singular.forEach(function (i) {
                ...
                t[e].forEach(function (e) {
                    e.element && e.animate(oW({x: t.startXPos}, e.startYPos ? {x: e.startXPos, y: e.startYPos} : {}))
                })
            })
        }
        ...
        destroy() {
            if (!this.destroyed) {
                let t = this, e = t.series, i = e.chart, s = e.options.dataSorting, o = i.hoverPoints,
                    r = oI(t.series.chart.renderer.globalAnimation), a = () => {
        ...
        getGraphicalProps(t) {
            let e, i, s = this, o = [], r = {singular: [], plural: []};
            for ((t = t || {
                graphic: 1,
                dataLabel: 1
        ...
        optionsToObject(t) {
            let e = this.series, i = e.options.keys, s = i || e.pointArrayMap || ["y"], o = s.length, r = {}, a, n = 0,
                h = 0;
            if (oj(t) || null === t) r[s[0]] = t; else if (oX(t)) for (!i && t.length > o && ("string" == (a = typeof t[0]) ? e.xAxis?.dateTime ? r.x = e.chart.time.parse(t[0]) : r.name = t[0] : "number" === a && (r.x = t[0]), n++); h < o;) i && void 0 === t[n] || (s[h].indexOf(".") > 0 ? oq.prototype.setNestedProperty(r, t[n], s[h]) : r[s[h]] = t[n]), n++, h++; else "object" == typeof t && (r = t, t.dataLabels && (e.hasDataLabels = () => !0), t.marker && (e._hasPointMarkers = !0));
            return r
        }
        ...
        select(t, e) {
            ...
            t = o$(t, !i.selected), this.selectedStaging = t, i.firePointEvent(t ? "select" : "unselect", {accumulate: e}, function () {
        ...
        setState(t, e) {
            let i = this.series, s = this.state, o = i.options.states[t || "normal"] || {},
                r = oD.plotOptions[i.type].marker && i.options.marker, a = r && !1 === r.enabled,
                n = r?.states?.[t || "normal"] || {}, h = !1 === n.enabled, l = this.marker || {}, d = i.chart,
                c = r && i.markerAttribs, p = i.halo, g, u, f, m = i.stateMarkerGraphic, x;
            ...
            }, t6.filterUserAttributes(y.attributes || {})))) : p?.point?.haloPath && !p.point.destroyed && p.animate({d: p.point.haloPath(0)}, null, p.hide), oH(this, "afterSetState", {state: t})
        }
    ...
    let oK = oq, {parse: oJ} = tL, {charts: oQ, composed: o0, isTouchDevice: o1} = w, {
        addEvent: o2,
        attr: o3,
        css: o5,
        extend: o6,
    ...
    class rr {
        ...
        getSelectionMarkerAttrs(t, e) {
            ...
            return o4(this, "getSelectionMarkerAttrs", i, i => {
                let s, {chart: o, zoomHor: r, zoomVert: a} = this, {mouseDownX: n = 0, mouseDownY: h = 0} = o,
                    l = i.attrs;
        ...
        drag(t) {
            let {chart: e} = this, {mouseDownX: i = 0, mouseDownY: s = 0} = e, {
                ...
                } = e.options.chart, n = e.plotLeft, h = e.plotTop, l = e.plotWidth, d = e.plotHeight,
                c = o7(o) ? o.enabled : o, p = r && t[`${r}Key`], g = t.chartX, u = t.chartY, f,
            ...
            if ((!m || !m.touch) && (g < n ? g = n : g > n + l && (g = n + l), u < h ? u = h : u > h + d && (u = h + d), this.hasDragged = Math.sqrt(Math.pow(i - g, 2) + Math.pow(s - u, 2)), this.hasDragged > 10)) {
                ...
                this.hasZoom && f && !p && !m && (this.selectionMarker = m = e.renderer[r](), m.attr({
                    ...
                    zIndex: 7
                }).add(), e.styledMode || m.attr({fill: a || oJ("#334eff").setOpacity(.25).get()})), m && m.attr(l), f && !m && c && e.pan(t, o)
            }
        }
        ...
        drop(t) {
            ...
            i && o8(i.index) && (o5(i.container, {cursor: i._cursor}), i.cancelClick = this.hasDragged > 10, i.mouseIsDown = !1, this.hasDragged = 0, this.pinchDown = [])
        }
        ...
        findNearestKDPoint(t, e, i) {
            ...
            return t.forEach(function (t) {
                ...
                o7(r, !0) && r.series && (!o7(s, !0) || function (t, i) {
                    let s, o = t.distX - i.distX, r = t.dist - i.dist,
        ...
        getHoverData(t, e, i, s, o, r) {
            ...
            }) : a.push(c)), o4(this, "afterGetHoverData", d = {hoverPoint: c}), {
        ...
        onContainerClick(t) {
            ...
            !e.cancelClick && (i && this.inClass(s.target, "highcharts-tracker") ? (o4(i.series, "click", o6(s, {point: i})), e.hoverPoint && i.firePointEvent("click", s)) : (o6(s, this.getCoordinates(s)), e.isInsidePlot(s.chartX - o, s.chartY - r, {visiblePlotOnly: !0}) && o4(e, "click", s)))
        }
        ...
        pinch(t) {
            let e = this, {chart: i, hasZoom: s, lastTouches: o} = e,
                ...
                h = i.tooltip, l = 1 === a && ri(h?.options.followTouchMove, !0);
        ...
        runPointActions(t, e, i) {
            let s = this.chart, o = s.series, r = s.tooltip?.options.enabled ? s.tooltip : void 0, a = !!r && r.shared,
                n = e || s.hoverPoint, h = n?.series || s.hoverSeries,
                l = (!t || "touchmove" !== t.type) && (!!e || h?.directTouch && this.isDirectTouch),
                d = this.getHoverData(n, h, o, l, a, t);
            n = d.hoverPoint, h = d.hoverSeries;
            let c = d.hoverPoints, p = h?.tooltipOptions.followPointer && !h.tooltipOptions.split,
        ...
        setDOMEvents() {
            ...
            this.eventsToUnbind.push(o2(t, "touchstart", this.onContainerTouchStart.bind(this), {passive: !1}), o2(t, "touchmove", this.onContainerTouchMove.bind(this), {passive: !1})), rr.unbindDocumentTouchEnd || (rr.unbindDocumentTouchEnd = o2(e, "touchend", this.onDocumentTouchEnd.bind(this), {passive: !1})), this.setPointerCapture(), o2(this.chart, "redraw", this.setPointerCapture.bind(this))
        }
        ...
        setPointerCapture() {
            ...
            })), e.styledMode || o5(i, {"touch-action": "none"}), i.className += " highcharts-no-touch-action", this.hasPointerCapture = !0) : this.hasPointerCapture && !s && (t.forEach(t => t()), t.length = 0, e.styledMode || o5(i, {"touch-action": ri(e.options.chart.style?.["touch-action"], "manipulation")}), i.className = i.className.replace(" highcharts-no-touch-action", ""), this.hasPointerCapture = !1)
        }
        ...
        touch(t, e) {
            ...
            this.setHoverChartIndex(), 1 === (t = this.normalize(t)).touches.length ? s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {visiblePlotOnly: !0}) && !s.exporting?.openMenu ? (e && this.runPointActions(t), "touchmove" === t.type && (i = !!o[0] && Math.pow(o[0].chartX - t.chartX, 2) + Math.pow(o[0].chartY - t.chartY, 2) >= 16), ri(i, !0) && this.pinch(t)) : e && this.reset() : 2 === t.touches.length && this.pinch(t)
        }
    ...
    !function (t) {
        t.setLength = function (t, e, i) {
            ...
            let r = Object.getPrototypeOf(t).constructor, a = t[s ? "subarray" : "slice"](e, e + i),
    ...
    !function (t) {
        function e(t, e, i) {
            let s = this.legendItem = this.legendItem || {}, {chart: o, options: r} = this, {
                    baseline: a = 0,
                    symbolWidth: n,
                    symbolHeight: h
                } = t, l = this.symbol || "circle", d = h / 2, c = o.renderer, p = s.group,
                g = a - Math.round((t.fontMetrics?.b || h) * (i ? .4 : .3)), u = {}, f, m = r.marker, x = 0;
            ...
            if (m && !1 !== m.enabled && n) {
                ...
                0 === l.indexOf("url") && (m = ru(m, {
                    width: h,
                    height: h
                }), t = 0), s.symbol = f = c.symbol(l, n / 2 - t, g - t, 2 * t, 2 * t, rg({context: "legend"}, m)).addClass("highcharts-point").add(p), f.isMarker = !0
            }
        }
        ...
        t.areaMarker = function (t, i) {
            ...
            let i = e.legendItem || {}, s = t.options, o = t.symbolHeight, r = s.squareSymbol,
                a = r ? o : t.symbolWidth;
            i.symbol = this.chart.renderer.rect(r ? (t.symbolWidth - o) / 2 : 0, t.baseline - o + 1, a, o, rf(t.options.symbolRadius, o / 2)).addClass("highcharts-point").attr({zIndex: 3}).add(i.group)
        }
    }(c || (c = {}));
    ...
    !function (t) {
        ...
        t.seriesTypes = w.seriesTypes, t.registerSeriesType = e, t.seriesType = function (i, s, o, r, a) {
            ...
            if (s = s || "", n[i] = rv(n[s], o), delete t.seriesTypes[i], e(i, rb(t.seriesTypes[s] || function () {
            }, r)), t.seriesTypes[i].prototype.type = i, a) {
                class e extends oK {
                }
    ...
    let rk = p, {
        animObject: rw,
        setAnimation: rM
    } = tU, {defaultOptions: rS} = tv, {registerEventOptions: rT} = si, {
        svg: rC,
        win: rA
    } = w, {seriesTypes: rP} = rk, {format: rL} = ep, {
        arrayMax: rO,
        arrayMin: rE,
        clamp: rI,
        correctFloat: rD,
    ...
    class r0 {
        ...
        autoIncrement(t) {
            let e, i = this.options, {pointIntervalUnit: s, relativeXValue: o} = this.options, r = this.chart.time,
        ...
        setOptions(t) {
            let e, i = this.chart, s = i.options.plotOptions, o = i.userOptions || {}, r = r_(t), a = i.styledMode,
                n = {plotOptions: s, userOptions: r};
            rG(this, "setOptions", n);
            let h = n.plotOptions[this.type], l = o.plotOptions || {}, d = l.series || {},
                c = rS.plotOptions[this.type] || {}, p = l[this.type] || {};
            ...
            }), rG(this, "afterSetOptions", {options: g}), g
        }
        ...
        updateData(t, e) {
            let {options: i, requireSorting: s} = this, o = i.dataSorting, r = this.points, a = [],
                n = t.length === r.length, h, l, d, c, p = !0;
            if (this.xIncrement = null, t.forEach((t, e) => {
                let l, d = rN(t) && this.pointClass.prototype.optionsToObject.call({series: this}, t) || {}, {
                    id: p,
                    x: g
                } = d;
        ...
        setData(t, e = !0, i, s) {
            let o = this.points, r = o?.length || 0, a = this.options, n = this.chart, h = a.dataSorting,
                l = this.xAxis, d = a.turboThreshold, c = this.dataTable, p = this.dataColumnKeys(),
                g = this.pointValKey || "y", u = (this.pointArrayMap || []).length, f = a.keys, m, x, y = 0, b = 1, v;
            ...
            if (h?.enabled && (t = this.sortData(t)), n.options.chart.allowMutatingData && !1 !== s && k && r && !this.cropped && !this.hasGroupedData && this.visible && !this.boosted && (x = this.updateData(t, i)), !x) {
                ...
                if (e) {
                    let i = this.getFirstValidPoint(t), s = this.getFirstValidPoint(t, k - 1, -1),
                        o = t => !!(r$(t) && (f || rV(t[0])));
                    if (rV(i) && rV(s)) {
                        let e = [], i = [];
        ...
        getProcessedData(t) {
            let e = this, {dataTable: i, isCartesian: s, options: o, xAxis: r} = e, a = o.cropThreshold,
                n = t || e.getExtremesFromAll, h = r?.logarithmic, l = i.rowCount, d, c, p = 0, g, u, f,
                m = e.getColumn("x"), x = i, y = !1;
        ...
        generatePoints() {
            let t = this.options, e = this.processedData || t.data, i = this.dataTable.modified,
                s = this.getColumn("x", !0), o = this.pointClass, r = i.rowCount, a = this.cropStart || 0,
                n = this.hasGroupedData, h = t.keys, l = [], d = t.dataGrouping?.groupAll ? a : 0,
                c = this.xAxis?.categories, p = this.pointArrayMap || ["y"], g = this.dataColumnKeys(), u, f, m, x,
                y = this.data, b;
            if (!y && !n) {
                let t = [];
        ...
        getExtremes(t, e) {
            let {xAxis: i, yAxis: s} = this, o = e || this.getExtremesFromAll || this.options.getExtremesFromAll,
                r = o && this.cropped ? this.dataTable : this.dataTable.modified, a = r.rowCount,
                n = t || this.stackedYData,
                h = n ? [n] : (this.keysAffectYAxis || this.pointArrayMap || ["y"])?.map(t => r.getColumn(t, !0) || []) || [],
                l = this.getColumn("x", !0), d = [], c = this.requireSorting && !this.is("column") ? 1 : 0,
                p = !!s && s.positiveValuesOnly, g = o || this.cropped || !i, u, f, m, x = 0, y = 0;
        ...
        translate() {
            this.generatePoints();
            let t = this.options, e = t.stacking, i = this.xAxis, s = this.enabledDataSorting, o = this.yAxis,
                r = this.points, a = r.length, n = this.pointPlacementToXValue(), h = !!n, l = t.threshold,
                d = t.startFromThreshold ? l : 0, c = t?.nullInteraction && o.len, p, g, u, f, m = Number.MAX_VALUE;
            ...
            for (p = 0; p < a; p++) {
                let t, a = r[p], y = a.x, b, v, k = a.y, w = a.low,
        ...
        getValidPoints(t, e, i) {
            ...
            return (t || this.points || []).filter(function (t) {
                ...
                return (!!i || !t.isNull && !!rV(r)) && (!e || !!s.isInsidePlot(o, r, {inverted: s.inverted})) && !1 !== t.visible
            })
        }
        ...
        setClip() {
            let {chart: t, group: e, markerGroup: i} = this, s = t.sharedClips, o = t.renderer, r = t.getClipBox(this),
                a = this.getSharedClipKey(), n = s[a];
            n ? n.animate(r) : s[a] = n = o.clipRect(r), e && e.clip(!1 === this.options.clip ? void 0 : n), i && i.clip()
        }

        animate(t) {
            let {chart: e, group: i, markerGroup: s} = this, o = e.inverted, r = rw(this.options.animation),
        ...
        drawPoints(t = this.points) {
            let e, i, s, o, r, a, n, h = this.chart, l = h.styledMode, {colorAxis: d, options: c} = this, p = c.marker,
                g = c.nullInteraction, u = this[this.specialGroup || "markerGroup"], f = this.xAxis,
            ...
            if (!1 !== p.enabled || this._hasPointMarkers) for (e = 0; e < t.length; e++) {
                ...
                if ((m && !rN(r.enabled) || r.enabled) && (!c || g) && !1 !== i.visible) {
                    ...
                    let e = !1 !== i.isInside;
                    if (!s && e && ((n.width || 0) > 0 || i.hasImage) && (i.graphic = s = h.renderer.symbol(t, n.x, n.y, n.width, n.height, a ? r : p).add(u), this.enabledDataSorting && h.hasRendered && (s.attr({x: i.startXPos}), o = "animate")), s && "animate" === o && s[e ? "show" : "hide"](e).animate(n), s) {
        ...
        markerAttribs(t, e) {
            let i = this.options, s = i.marker, o = t.marker || {}, r = o.symbol || s.symbol, a = {}, n, h,
        ...
        pointAttribs(t, e) {
            let i = this.options, s = i.marker, o = t?.options, r = o?.marker || {}, a = o?.color, n = t?.color,
                h = t?.zone?.color, l, d, c = this.color, p, g, u = rK(r.lineWidth, s.lineWidth),
        ...
        destroy(t) {
            ...
            for (rG(s, "destroy", {keepEventsForUpdate: t}), this.removeEvents(t), (s.axisTypes || []).forEach(function (t) {
        ...
        applyZones() {
            let {
                ...
                yAxis: a,
                zoneAxis: n
            } = this, {inverted: h, renderer: l} = e, d = this[`${n}Axis`], {
                isXAxis: c,
                len: p = 0,
                minPointOffset: g = 0
        ...
        render() {
            let t = this, {chart: e, options: i, hasRendered: s} = t, o = rw(i.animation),
        ...
        searchKDTree(t, e, i, s, o) {
            let r = this, [a, n] = this.kdAxisArray, h = e ? "distX" : "dist",
                l = (r.options.findNearestPointBy || "").indexOf("y") > -1 ? 2 : 1, d = !!r.isBubble,
                c = s || ((t, e, i) => {
                    let s = t[i] || 0, o = e[i] || 0;
            ...
            if (this.kdTree || this.buildingKdTree || this.buildKDTree(i), this.kdTree) return function t(e, i, s, o) {
                ...
                !function (t, e) {
                    let i = t[a], s = e[a], o = rN(i) && rN(s) ? i - s : null, r = t[n], h = e[n],
                        l = rN(r) && rN(h) ? r - h : 0, c = d && e.marker?.radius || 0;
                    e.dist = Math.sqrt((o && o * o || 0) + l * l) - c, e.distX = rN(o) ? Math.abs(o) - c : Number.MAX_VALUE
                }(e, l);
                let m = (e[g] || 0) - (l[g] || 0) + (d && l.marker?.radius || 0), x = m < 0 ? "left" : "right",
                    y = m < 0 ? "right" : "left";
        ...
        drawTracker() {
            let t = this, e = t.options, i = e.trackByArea, s = [].concat((i ? t.areaPath : t.graphPath) || []),
                o = t.chart, r = o.pointer, a = o.renderer, n = o.options.tooltip?.snap || 0, h = () => {
        ...
        addPoint(t, e, i, s, o) {
            let r, a, n = this.options, {chart: h, data: l, dataTable: d, xAxis: c} = this, p = c?.hasNames && c.names,
                g = n.data, u = this.getColumn("x");
            e = rK(e, !0);
            let f = {series: this};
            this.pointClass.prototype.applyOptions.apply(f, [t]);
            let m = f.x;
            if (a = u.length, this.requireSorting && m < u[a - 1]) for (r = !0; a && u[a - 1] > m;) a--;
            d.setRow(f, a, !0, {addColumns: !1}), p && f.name && (p[m] = f.name), g?.splice(a, 0, t), (r || this.processedData) && (this.data.splice(a, 0, null), this.processData()), "point" === n.legendType && this.generatePoints(), i && (l[0] && l[0].remove ? l[0].remove(!1) : ([l, g].filter(rN).forEach(t => {
                t.shift()
            }), d.deleteRows(0))), !1 !== o && rG(this, "addPoint", {point: f}), this.isDirty = !0, this.isDirtyData = !0, e && h.redraw(s)
        }
        ...
        update(t, e) {
            ...
            let i = this, s = i.chart, o = i.userOptions, r = i.initialType || i.type, a = s.options.plotOptions,
                n = rP[r].prototype, h = i.finishedAnimating && {animation: !1}, l = {}, d, c, p = r0.keepProps.slice(),
            ...
            }, !u && {data: i.options.data}, t, h), u && t.data && (t.data = i.options.data), (p = ["group", "markerGroup", "dataLabelsGroup", "transformGroup"].concat(p)).forEach(function (t) {
                p[t] = i[t], delete i[t]
            });
            let f = !1;
            if (rP[g]) {
        ...
        setState(t, e) {
            ...
            if (t = t || "", i.state !== t && ([i.group, i.markerGroup, i.dataLabelsGroup].forEach(function (e) {
                ...
                if (t && (h = a[t].lineWidth || h + (a[t].lineWidthPlus || 0), l = rK(a[t].opacity, l)), o && !o.dashstyle && rV(h)) for (let t of [o, ...this.zones.map(t => t.graph)]) t?.animate({"stroke-width": h}, n);
    ...
    let r1 = r0, {animObject: r2, setAnimation: r3} = tU, {registerEventOptions: r5} = si, {
        composed: r6,
        marginNames: r9
    } = w, {distribute: r4} = ey, {format: r8} = ep, {
        addEvent: r7,
        createElement: at,
        css: ae,
        defined: ai,
    ...
    class ag {
        ...
        update(t, e) {
            let i = this.chart;
            this.setOptions(an(!0, this.options, t)), "events" in this.options && r5(this, this.options), this.destroy(), i.isDirtyLegend = i.isDirtyBox = !0, ah(e, !0) && i.redraw(), ar(this, "afterUpdate", {redraw: e})
        }
        ...
        colorizeItem(t, e) {
            ...
            if ((t instanceof r1 || t instanceof oK) && (t.color = t.options?.legendSymbolColor || i), o?.[e ? "removeClass" : "addClass"]("highcharts-legend-item-hidden"), !this.chart.styledMode) {
                let {itemHiddenStyle: i = {}} = this, o = i.color, {
                    fillColor: h,
                    fillOpacity: l,
                    lineColor: d,
                    marker: c
                } = t.options, p = t => (!e && (t.fill && (t.fill = o), t.stroke && (t.stroke = o)), t);
                r?.css(an(e ? this.itemStyle : i)), a?.attr(p({stroke: d || t.color})), n && n.attr(p(c && n.isMarker ? t.pointAttribs() : {fill: t.color})), s?.attr(p({
                    fill: h || t.color,
        ...
        positionItem(t) {
            let {group: e, x: i = 0, y: s = 0} = t.legendItem || {}, o = this.options, r = o.symbolPadding, a = !o.rtl,
                n = t.checkbox;
            if (e?.element) {
        ...
        setText(t) {
            let e = this.options;
            t.legendItem.label.attr({text: e.labelFormat ? r8(e.labelFormat, t, this.chart) : e.labelFormatter.call(t)})
        }

        renderItem(t) {
            let e = t.legendItem = t.legendItem || {}, i = this.chart, s = i.renderer, o = this.options,
                r = "horizontal" === o.layout, a = this.symbolWidth, n = o.symbolPadding || 0, h = this.itemStyle,
                l = this.itemHiddenStyle, d = r ? ah(o.itemDistance, 20) : 0, c = !o.rtl, p = !t.series,
                g = !p && t.series.drawLegendSymbol ? t.series : t, u = g.options,
                f = !!this.createCheckboxForItem && u && u.showCheckbox, m = o.useHTML, x = t.options.className,
                y = e.label, b = a + n + d + 20 * !!f;
            !y && (e.group = s.g("legend-item").addClass("highcharts-" + g.type + "-series highcharts-color-" + t.colorIndex + (x ? " " + x : "") + (p ? " highcharts-series-" + t.index : "")).attr({zIndex: 1}).add(this.scrollGroup), e.label = y = s.text("", c ? a + n : -n, this.baseline || 0, m), i.styledMode || y.css(an(t.visible ? h : l)), y.attr({
                align: c ? "left" : "right",
                zIndex: 2
        ...
        layoutItem(t) {
            let e = this.options, i = this.padding, s = "horizontal" === e.layout, o = t.itemHeight,
                r = this.itemMarginBottom, a = this.itemMarginTop, n = s ? ah(e.itemDistance, 20) : 0,
                h = this.maxLegendWidth,
                l = e.alignColumns && this.totalItemWidth > h ? this.maxItemWidth : t.itemWidth, d = t.legendItem || {};
        ...
        getAllItems() {
            ...
            }), ar(this, "afterGetAllItems", {allItems: t}), t
        }
        ...
        align(t = this.chart.spacingBox) {
            ...
            /(lth|ct|rth)/.test(this.getAlignment()) && e.titleOffset[0] > 0 ? s += e.titleOffset[0] : /(lbh|cb|rbh)/.test(this.getAlignment()) && e.titleOffset[2] > 0 && (s -= e.titleOffset[2]), s !== t.y && (t = an(t, {y: s})), e.hasRendered || (this.group.placed = !1), this.group.align(an(i, {
        ...
        handleOverflow(t) {
            let e = this, i = this.chart, s = i.renderer, o = this.options, r = o.y, a = "top" === o.verticalAlign,
                n = this.padding, h = o.maxHeight, l = o.navigation, d = ah(l.animation, !0), c = l.arrowSize || 12,
                p = this.pages, g = this.allItems, u = function (t) {
        ...
        scroll(t, e) {
            let i = this.chart, s = this.pages, o = s.length, r = this.clipHeight, a = this.options.navigation,
                n = this.pager, h = this.padding, l = this.currentPage + t;
            ...
            }, this), i.styledMode || (this.up.attr({fill: 1 === l ? a.inactiveColor : a.activeColor}), this.upTracker.css({cursor: 1 === l ? "default" : "pointer"}), this.down.attr({fill: l === o ? a.inactiveColor : a.activeColor}), this.downTracker.css({cursor: l === o ? "default" : "pointer"})), this.scrollOffset = -s[l - 1] + this.initialItemY, this.scrollGroup.animate({translateY: this.scrollOffset}), this.currentPage = l, this.positionCheckboxes(), ap(() => {
                ar(this, "afterScroll", {currentPage: l})
            }, r2(ah(e, i.renderer.globalAnimation, !0)).duration))
        }

        setItemEvents(t, e, i) {
            let s = this, o = t.legendItem || {}, r = s.chart.renderer.boxWrapper, a = t instanceof oK,
                n = t instanceof r1, h = "highcharts-legend-" + (a ? "point" : "series") + "-active",
                l = s.chart.styledMode, d = i ? [e, o.symbol] : [o.group], c = e => {
            ...
            for (let i of d) i && i.on("mouseover", function () {
                ...
                r.removeClass(h), ar(s, "itemClick", {
                    browserEvent: e,
                    legendItem: t
                }, i), a ? t.firePointEvent("legendItemClick", {browserEvent: e}) : n && ar(t, "legendItemClick", {browserEvent: e})
            })
        }
    ...
    let au = ag, {
        ...
        animObject: am,
        setAnimation: ax
    } = tU, {defaultOptions: ay} = tv, {numberFormat: ab} = ep, {registerEventOptions: av} = si, {
        charts: ak,
        doc: aw,
        marginNames: aM,
        svg: aS,
    ...
    class a0 {
        ...
        orderItems(t, e = 0) {
            let i = this[t], s = this.options[t] = aK(this.options[t]).slice(),
        ...
        isInsidePlot(t, e, i = {}) {
            let {inverted: s, plotBox: o, plotLeft: r, plotTop: a, scrollablePlotBox: n} = this, {
                ...
                c = i.visiblePlotOnly && n || o, p = i.inverted ? e : t, g = i.inverted ? t : e,
        ...
        redraw(t) {
            ...
            let e = this.hasCartesianSeries ? this.axes : this.colorAxis || [], i = this.series, s = this.pointer,
                o = this.legend, r = this.userOptions.legend, a = this.renderer, n = a.isHidden(), h = [], l, d, c,
                p = this.isDirtyBox, g = this.isDirtyLegend, u;
        ...
        applyDescription(t, e) {
            ...
            o && e && (this[t] = o = o.destroy()), s && !o && ((o = this.renderer.text(s.text, 0, 0, s.useHTML).attr({
                ...
                class: "highcharts-" + t,
                zIndex: s.zIndex || 4
            }).css({textOverflow: "ellipsis", whiteSpace: "nowrap"}).add()).update = function (e, s) {
                i.applyDescription(t, e), i.layOutTitles(s)
            }, this.styledMode || o.css(az("title" === t ? {fontSize: this.options.isStock ? "1em" : "1.2em"} : {}, s.style)), o.textPxLength = o.getBBox().width, o.css({whiteSpace: s.style?.whiteSpace}), this[t] = o)
        }

        layOutTitles(t = !0) {
            let e = [0, 0, 0], {options: i, renderer: s, spacingBox: o} = this;
            ["title", "subtitle", "caption"].forEach(t => {
                ...
                if (i && r) {
                    ...
                    let o = s.fontMetrics(i), h = o.b, l = o.h, d = r.verticalAlign || "top", c = "top" === d,
                        p = c && r.minScale || 1, g = "title" === t ? c ? -3 : 0 : c ? e[0] + 2 : 0,
                        u = Math.min(a.width / n, 1), f = Math.max(p, u),
                        m = aU({y: "bottom" === d ? h : g + h}, {align: "title" === t ? u < p ? "left" : "center" : this.title?.alignValue}, r),
        ...
        getContainerBox() {
            ...
            }), e = {width: aF(this.renderTo, "width", !0) || 0, height: aF(this.renderTo, "height", !0) || 0};
        ...
        temporaryDisplay(t) {
            ...
            if (t) for (; e?.style;) e.hcOrigStyle && (aO(e, e.hcOrigStyle), delete e.hcOrigStyle), e.hcOrigDetached && (aw.body.removeChild(e), e.hcOrigDetached = !1), e = e.parentNode; else for (; e?.style && (aw.body.contains(e) || e.parentNode || (e.hcOrigDetached = !0, aw.body.appendChild(e)), ("none" === aF(e, "display", !1) || e.hcOricDetached) && (e.hcOrigStyle = {
        ...
        getContainer() {
            let t, e = this.options, i = e.chart, s = "data-highcharts-chart", o = aQ(), r = this.renderTo,
                a = aZ(aP(r, s));
            ...
            aO(r, {overflow: "hidden"}), this.styledMode || (t = az({
                position: "relative",
                overflow: "hidden",
                width: h + "px",
                height: n + "px",
            ...
            this.container = l, this.getChartSize(), h !== this.chartWidth && (h = this.chartWidth, this.styledMode || aO(l, {width: aV(i.style?.width, h + "px")})), this.containerBox = this.getContainerBox(), this._cursor = l.style.cursor;
        ...
        setChartSize(t) {
            let e, i, s, o, {chartHeight: r, chartWidth: a, inverted: n, spacing: h, renderer: l} = this,
                d = this.clipOffset, c = Math[n ? "floor" : "round"];
            this.plotLeft = e = Math.round(this.plotLeft), this.plotTop = i = Math.round(this.plotTop), this.plotWidth = s = Math.max(0, Math.round(a - e - (this.marginRight ?? 0))), this.plotHeight = o = Math.max(0, Math.round(r - i - (this.marginBottom ?? 0))), this.plotSizeX = n ? o : s, this.plotSizeY = n ? s : o, this.spacingBox = l.spacingBox = {
                ...
                width: a - h[3] - h[1],
                height: r - h[0] - h[2]
            }, this.plotBox = l.plotBox = {x: e, y: i, width: s, height: o}, d && (this.clipBox = {
                x: c(d[3]),
                y: c(d[0]),
            ...
            }), l.alignElements()), aW(this, "afterSetChartSize", {skipAxes: t})
        }
        ...
        drawChartBox() {
            let t = this.options.chart, e = this.renderer, i = this.chartWidth, s = this.chartHeight,
                ...
                h = t.plotBackgroundImage, l = this.plotLeft, d = this.plotTop, c = this.plotWidth, p = this.plotHeight,
                g = this.plotBox, u = this.clipRect, f = this.clipBox, m = this.chartBackground,
                x = this.plotBackground, y = this.plotBorder, b, v, k, w = "animate";
            m || (this.chartBackground = m = e.rect().addClass("highcharts-background").add(), w = "attr"), o ? b = v = m.strokeWidth() : (v = (b = t.borderWidth || 0) + 8 * !!t.shadow, k = {fill: a || "none"}, (b || m["stroke-width"]) && (k.stroke = t.borderColor, k["stroke-width"] = b), m.attr(k).shadow(t.shadow)), m[w]({
                x: v / 2,
                y: v / 2,
                width: i - v - b % 2,
                height: s - v - b % 2,
                r: t.borderRadius
            }), w = "animate", x || (w = "attr", this.plotBackground = x = e.rect().addClass("highcharts-plot-background").add()), x[w](g), !o && (x.attr({fill: n || "none"}).shadow(t.plotShadow), h && (r ? (h !== r.attr("href") && r.attr("href", h), r.animate(g)) : this.plotBGImage = e.image(h, l, d, c, p).add())), u ? u.animate({
                width: f.width,
                height: f.height
            }) : this.clipRect = e.clipRect(f), w = "animate", y || (w = "attr", this.plotBorder = y = e.rect().addClass("highcharts-plot-border").attr({zIndex: 1}).add()), o || y.attr({
        ...
        render() {
            ...
            this.drawChartBox(), this.hasCartesianSeries ? o(t) : e?.length && o(e), this.seriesGroup || (this.seriesGroup = i.g("series-group").attr({zIndex: 3}).shadow(this.options.chart.seriesGroupShadow).add()), this.dataLabelsGroup || (this.dataLabelsGroup = i.g("datalabels-group").attr({zIndex: 6}).add()), this.renderSeries(), this.addCredits(), this.setResponsive && this.setResponsive(), this.hasRendered = !0
        }
        ...
        addSeries(t, e, i) {
            let s, o = this;
            return t && (e = aV(e, !0), aW(o, "addSeries", {options: t}, function () {
                s = o.initSeries(t), o.isDirtyLegend = !0, o.linkSeries(), s.enabledDataSorting && s.setData(t.data, !1), aW(o, "afterAddSeries", {series: s}), e && o.redraw(i)
            })), s
        }
        ...
        showLoading(t) {
            ...
            r || (e.loadingDiv = r = aL("div", {className: "highcharts-loading highcharts-loading-hidden"}, null, e.container)), a || (e.loadingSpan = a = aL("span", {className: "highcharts-loading-inner"}, null, r), aA(e, "redraw", o)), r.className = "highcharts-loading", t6.setElementHTML(a, aV(t, i.lang.loading, "")), !e.styledMode && (aO(r, az(s.style, {zIndex: 10})), aO(a, s.labelStyle), e.loadingShown || (aO(r, {
                opacity: 0,
                display: ""
            }), af(r, {opacity: s.style.opacity || .5}, {duration: s.showDuration || 0}))), e.loadingShown = !0, o()
        }

        hideLoading() {
            let t = this.options, e = this.loadingDiv;
            e && (e.className = "highcharts-loading highcharts-loading-hidden", this.styledMode || af(e, {opacity: 0}, {
        ...
        update(t, e, i, s) {
            ...
            aW(n, "update", {options: t}), l || n.setResponsive(!1, !0), t = aI(t, n.options), n.userOptions = aU(n.userOptions, t);
            let c = t.chart;
        ...
        showResetZoom() {
            let t = this, e = ay.lang, i = t.zooming.resetButton, s = i.theme,
        ...
        zoomOut() {
            aW(this, "selection", {resetSelection: !0}, () => this.transform({reset: !0, trigger: "zoom"}))
        }
        ...
        pan(t, e) {
            ...
            a?.panning && (a.panning = s), aW(this, "pan", {originalEvent: t}, () => {
                i.transform({
                    axes: r,
                    event: t,
        ...
        transform(t) {
            let {
                ...
                to: a = {},
                trigger: n
            } = t, {inverted: h, time: l} = this;
            this.hoverPoints?.forEach(t => t.setState()), aW(this, "transform", t);
            let d = t.hasZoomed || !1, c, p;
            for (let t of e) {
                let {horiz: e, len: g, minPointOffset: u = 0, options: f, reversed: m} = t, x = e ? "width" : "height",
                    y = e ? "x" : "y", b = aV(a[x], t.len), v = aV(s[x], t.len), k = 10 > Math.abs(b) ? 1 : b / v,
                    w = (s[y] || 0) + v / 2 - t.pos, M = w - ((a[y] ?? t.pos) + b / 2 - t.pos) / k,
                    S = m && !h || !m && h ? -1 : 1;
                if (!o && (w < 0 || w > t.len)) continue;
                let T = t.chart.polar || t.isOrdinal ? 0 : u * S || 0, C = t.toValue(M, !0),
                    A = t.toValue(M + g / k, !0), P = C + T, L = A - T, O = t.allExtremes;
                if (r && r[t.coll].push({
                    axis: t,
                    min: Math.min(C, A),
                    max: Math.max(C, A)
                ...
                let {dataMin: E, dataMax: I, min: D, max: B} = az(t.getExtremes(), O || {}), N = l.parse(f.min),
                    z = l.parse(f.max), R = E ?? N, W = I ?? z, H = L - P, F = t.categories ? 0 : Math.min(H, W - R),
                    X = R - F * (aE(N) ? 0 : f.minPadding), G = W + F * (aE(z) ? 0 : f.maxPadding),
                    j = t.allowZoomOutside || 1 === k || "zoom" !== n && k > 1, Y = Math.min(N ?? X, X, j ? D : X),
    ...
    class ni {
        ...
        static afterSetSize(t, e) {
            let i, s, o, {minWidth: r, minHeight: a} = t.options.chart.scrollablePlotArea || {}, {
                clipBox: n,
                plotBox: h,
                inverted: l,
                renderer: d
        ...
        constructor(t) {
            let e, i = t.options.chart, s = eg.getRendererType(), o = i.scrollablePlotArea || {},
            ...
            let n = this.parentDiv = a5("div", {className: "highcharts-scrolling-parent"}, {position: "relative"}, t.renderTo),
                h = this.scrollingContainer = a5("div", {className: "highcharts-scrolling"}, a, n),
                l = this.innerContainer = a5("div", {className: "highcharts-inner-container"}, void 0, h),
                d = this.fixedDiv = a5("div", {className: "highcharts-fixed"}, {
                    position: "absolute",
                    overflow: "hidden",
                    pointerEvents: "none",
            ...
            this.mask = c.path().attr({
                ...
                zIndex: -1
            }).addClass("highcharts-scrollable-mask").add(), h.parentNode.insertBefore(d, h), a6(t.renderTo, {overflow: "visible"}), a3(t, "afterShowResetZoom", r), a3(t, "afterApplyDrilldown", r), a3(t, "afterLayOutTitles", r), a3(h, "scroll", () => {
        ...
        applyFixed() {
            let {chart: t, fixedRenderer: e, isDirty: i, scrollingContainer: s} = this, {
                ...
                } = t, {scrollPositionX: u = 0, scrollPositionY: f = 0} = t.options.chart.scrollablePlotArea || {},
                m = r + p, x = a + g;
            ...
            }), t.chartBackground?.attr({width: m, height: x}), a6(s, {
                width: `${r}px`,
                height: `${a}px`
            }), a9(i) || (s.scrollLeft = p * u, s.scrollTop = g * f);
            let y = d - o[0] - 1, b = l - o[3] - 1, v = d + h + o[2] + 1, k = l + c + o[1] + 1, w = l + c - p,
                M = d + h - g, S = [["M", 0, 0]];
            p ? S = [["M", 0, y], ["L", l - 1, y], ["L", l - 1, v], ["L", 0, v], ["Z"], ["M", w, y], ["L", r, y], ["L", r, v], ["L", w, v], ["Z"]] : g && (S = [["M", b, 0], ["L", b, d - 1], ["L", k, d - 1], ["L", k, 0], ["Z"], ["M", b, M], ["L", b, a], ["L", k, a], ["L", k, M], ["Z"]]), "adjustHeight" !== t.redrawTrigger && this.mask.attr({d: S})
        }

        moveFixedElements() {
            let t, {container: e, inverted: i, scrollablePixelsX: s, scrollablePixelsY: o} = this.chart,
                r = this.fixedRenderer, a = ni.fixedSelectors;
    ...
    let {format: ns} = ep, {series: no} = rk, {
        ...
        render(t) {
            ...
            if (this.label) this.label.attr({text: o, visibility: "hidden"}); else {
                ...
                let s = {r: i.borderRadius || 0, text: o, padding: nl(i.padding, 5), visibility: "hidden"};
        ...
        setOffset(t, e, i, s, o, r) {
            let {alignOptions: a, axis: n, label: h, options: l, textAlign: d} = this, c = n.chart,
                p = this.getStackBox({
                    xOffset: t,
                    width: e,
                    boxBottom: i,
        ...
        adjustStackPosition({labelBox: t, verticalAlign: e, textAlign: i}) {
            return {x: t.width / 2 + t.width / 2 * (2 * nn(i) - 1), y: t.height / 2 * 2 * (1 - nn(e))}
        }

        getStackBox(t) {
            let e = this.axis, i = e.chart, {boxTop: s, defaultX: o, xOffset: r, width: a, boxBottom: n} = t,
                h = e.stacking.usePercentage ? 100 : nl(s, this.total, 0), l = e.toPixels(h), d = t.xAxis || i.xAxis[0],
                c = nl(o, d.translate(this.x)) + r,
                p = Math.abs(l - e.toPixels(n || nh(e.min) && e.logarithmic && e.logarithmic.lin2log(e.min) || 0)),
                g = i.inverted, u = this.isNegative;
            return g ? {
    ...
    }, {getDeferredAnimation: nc} = tU, {series: {prototype: np}} = rk, {
        addEvent: ng,
        correctFloat: nu,
        defined: nf,
    ...
    function nT() {
        let t, e = this, i = e.yAxis, s = e.stackKey || "", o = i.stacking.stacks, r = e.getColumn("x", !0),
    ...
    function nP(t, e) {
        ...
        let d = this.getColumn("x", !0), c = this.getColumn(this.pointValKey || "y", !0), p = [], g = c.length,
            u = this.options, f = u.threshold || 0, m = u.startFromThreshold ? f : 0, x = u.stack,
            y = e ? `${this.type},${l}` : this.stackKey || "", b = "-" + y, v = this.negStacks, k = t.stacking,
            w = k.stacks, M = k.oldStacks;
    ...
    class nB extends r1 {
        drawGraph() {
            ...
            [this, ...this.zones].forEach((s, o) => {
                ...
                a ? (a.endX = this.preventGraphAnimation ? null : e.xMap, a.animate({d: e})) : e.length && (s.graph = a = this.chart.renderer.path(e).addClass("highcharts-graph" + (o ? ` highcharts-zone-graph-${o - 1} ` : " ") + (o && s.className || "")).attr({zIndex: 1}).add(this.group)), a && !i && (r = {
                    stroke: !o && t.lineColor || s.color || this.color || "#cccccc",
                    "stroke-width": t.lineWidth || 0,
                    fill: this.fillGraph && this.color || "none"
                }, h ? r.dashstyle = h : "square" !== t.linecap && (r["stroke-linecap"] = r["stroke-linejoin"] = "round"), a[n](r).shadow(t.shadow && nI({filterUnits: "userSpaceOnUse"}, nD(t.shadow) ? t.shadow : {}))), a && (a.startX = e.xMap, a.isArea = e.isArea)
            })
        }
    ...
    class nF extends nN {
        ...
        getGraphPath(t) {
            let e, i, s, o = nN.prototype.getGraphPath, r = this.options, a = r.stacking, n = this.yAxis, h = [],
                l = [], d = this.index, c = n.stacking.stacks[this.stackKey], p = r.threshold,
                g = Math.round(n.getThreshold(r.threshold)), u = nH(r.connectNulls, "percent" === a),
                f = function (i, s, o) {
                    let r = t[i], u = a && c[r.x].points[d], f = r[o + "Null"] || 0, m = r[o + "Cliff"] || 0, x, y,
                        b = !0;
        ...
        getStackPoints(t) {
            let e = this, i = [], s = [], o = this.xAxis, r = this.yAxis, a = r.stacking.stacks[this.stackKey], n = {},
                h = r.series, l = h.length, d = r.options.reversedStacks ? 1 : -1, c = h.indexOf(e);
    ...
    }), nz(nF.prototype, {singleStacks: !1}), rk.registerSeriesType("area", nF);
    ...
    let {animObject: nK} = tU, {parse: nJ} = tL, {noop: nQ} = w, {
        clamp: n0,
        crisp: n1,
        defined: n2,
        extend: n3,
    ...
    class ht extends r1 {
        animate(t) {
            let e, i, s = this, o = this.yAxis, r = o.pos, a = o.reversed, n = s.options, {
                clipOffset: h,
                inverted: l
            } = this.chart, d = {}, c = l ? "translateX" : "translateY";
            t && h ? (d.scaleY = .001, i = n0(o.toPixels(n.threshold || 0), r, r + o.len), l ? d.translateX = (i += a ? -Math.floor(h[0]) : Math.ceil(h[2])) - o.len : d.translateY = i += a ? Math.ceil(h[0]) : -Math.floor(h[2]), s.clipBox && s.setClip(), s.group.attr(d)) : (e = Number(s.group.attr(c)), s.group.animate({scaleY: 1}, n3(nK(s.options.animation), {
                step: function (t, i) {
        ...
        getColumnMetrics() {
            let t = this, e = t.options, i = t.xAxis, s = t.yAxis, o = i.options.reversedStacks,
                r = i.reversed && !o || !i.reversed && o, a = {}, n, h = 0;
        ...
        translate() {
            let t = this, e = t.chart, i = t.options, s = t.dense = t.closestPointRange * t.xAxis.transA < 2,
                o = t.borderWidth = n8(i.borderWidth, +!s), r = t.xAxis, a = t.yAxis, n = i.threshold,
                h = n8(i.minPointLength, 5), l = t.getColumnMetrics(), d = l.width, c = t.pointXOffset = l.offset,
                p = t.dataMin, g = t.dataMax, u = t.translatedThreshold = a.getThreshold(n),
                f = t.barW = Math.max(d, 1 + 2 * o);
            i.pointPadding && i.crisp && (f = Math.ceil(f)), r1.prototype.translate.apply(t), t.points.forEach(function (s) {
                let o = n8(s.yBottom, u), m = 999 + Math.abs(o), x = s.plotX || 0, y = n0(s.plotY, -m, a.len + m), b,
                    v = Math.min(y, o), k = Math.max(y, o) - v, w = d, M = x + c, S = f;
        ...
        pointAttribs(t, e) {
            let i = this.options, s = this.pointAttrToOptions || {}, o = s.stroke || "borderColor",
                r = s["stroke-width"] || "borderWidth", a, n, h, l = t && t.color || this.color,
                d = t && t[o] || i[o] || l, c = t && t.options.dashStyle || i.dashStyle,
        ...
        drawTracker(t = this.points) {
            let e, i = this, s = i.chart, o = s.pointer, r = function (t) {
                ...
                o && e && i.options.enableMouseTracking && (s.isInsidePlot(t.chartX - s.plotLeft, t.chartY - s.plotTop, {visiblePlotOnly: !0}) || o?.inClass(t.target, "highcharts-data-label")) && (o.isDirectTouch = !0, e.onMouseOver(t))
            };
            t.forEach(function (t) {
    ...
    let he = ht, {getDeferredAnimation: hi} = tU, {format: hs} = ep, {
        defined: ho,
        extend: hr,
        fireEvent: ha,
        getAlignFactor: hn,
    ...
    !function (t) {
        ...
        function i(t, e, i, s, o) {
            let {chart: r, enabledDataSorting: a} = this, n = this.isCartesian && r.inverted, h = t.plotX, l = t.plotY,
                d = i.rotation || 0, c = ho(h) && ho(l) && r.isInsidePlot(h, Math.round(l), {
                    inverted: n,
                    paneCoordinates: !0,
                    series: this
        ...
        function r(t) {
            let e;
            t = t || this.points;
            let i = this, s = i.chart, o = i.options, r = s.renderer, {
                backgroundColor: a,
                plotBackgroundColor: l
            } = s.options.chart, d = r.getContrast(hl(l) && l || hl(a) && a || "#000000"), c = h(i), {
                animation: p,
                defer: g
            } = c[0], u = g ? hi(s, p, i) : {defer: 0, duration: 0};
            ha(this, "drawDataLabels"), i.hasDataLabels?.() && (e = this.initDataLabels(u), t.forEach(t => {
                ...
                hu(n(c, t.dlOptions || t.options?.dataLabels)).forEach((n, l) => {
                    let c = n.enabled && (t.visible || t.dataLabelOnHidden) && (!t.isNull || t.dataLabelOnNull) && function (t, e) {
                            ...
                            return !0
                        }(t, n), {backgroundColor: p, borderColor: g, distance: u, style: f = {}} = n, m, x, y, b = {},
                        v = a[l], k = !v, w;
        ...
        function a(t, e, i, s, o, r) {
            let a = this.chart, n = e.align, h = e.verticalAlign, l = t.box ? 0 : t.padding || 0,
                d = a.inverted ? this.yAxis : this.xAxis, c = d ? d.left - a.plotLeft : 0,
                p = a.inverted ? this.xAxis : this.yAxis, g = p ? p.top - a.plotTop : 0, {x: u = 0, y: f = 0} = e, m, x;
        ...
        function l(t, e, i, s, o) {
            let r = this.chart, a = r.inverted, n = this.xAxis, h = n.reversed, l = ((a ? e.height : e.width) || 0) / 2,
                d = t.pointWidth, c = d ? d / 2 : 0;
            e.startXPos = a ? o.x : h ? -l - c : n.width - l + c, e.startYPos = a ? h ? this.yAxis.height - l + c : -l - c : o.y, s ? "hidden" === e.visibility && (e.show(), e.attr({opacity: 0}).animate({opacity: 1})) : e.attr({opacity: 1}).animate({opacity: 0}, void 0, e.hide), r.hasRendered && (i && e.attr({
                x: e.startXPos,
                y: e.startYPos
            }), e.placed = !0)
        }
    ...
    !function (t) {
        function e(t, e, i, s, o) {
            let {chart: r, options: a} = this, n = r.inverted, h = this.xAxis?.len || r.plotSizeX || 0,
                l = this.yAxis?.len || r.plotSizeY || 0, d = t.dlBox || t.shapeArgs,
                c = t.below ?? (t.plotY || 0) > (this.translatedThreshold ?? l), p = i.inside ?? !!a.stacking;
            if (d) {
            ...
            i.align ?? (i.align = !n || p ? "center" : c ? "right" : "left"), i.verticalAlign ?? (i.verticalAlign = n || p ? "middle" : c ? "top" : "bottom"), hx.prototype.alignDataLabel.call(this, t, e, i, s, o), i.inside && t.contrastColor && e.css({color: t.contrastColor})
        }
    ...
    hM.defaultOptions = hw(he.defaultOptions, {}), hk(hM.prototype, {inverted: !0}), rk.registerSeriesType("bar", hM);
    ...
    !function (t) {
        t.getCenter = function () {
            let t = this.options, e = this.chart, i = 2 * (t.slicedOffset || 0), s = e.plotWidth - 2 * i,
                o = e.plotHeight - 2 * i, r = t.center, a = Math.min(s, o), n = t.thickness, h, l = t.size,
                d = t.innerSize || 0, c, p;
            ...
            return g[3] > g[2] && (g[3] = g[2]), hI(n) && 2 * n < g[2] && n > 0 && (g[3] = g[2] - 2 * n), hE(this, "afterGetCenter", {positions: g}), g
        }, t.getStartAndEndRadians = function (t, e) {
            let i = hI(t) ? t : 0, s = hI(e) && e > i && e - i < 360 ? e : i + 360;
            return {start: hO * (i + -90), end: hO * (s + -90)}
        }
    }(m || (m = {}));
    let hN = m, {setAnimation: hz} = tU, {
        addEvent: hR,
        defined: hW,
        extend: hH,
        isNumber: hF,
        ...
        connectorShapes: {
            fixedOffset: function (t, e, i) {
                ...
                let {
                        ...
                        breakAt: o,
                        touchingSliceAt: r
                    } = e, {series: a} = this, [n, h, l] = a.center, d = l / 2, {plotLeft: c, plotWidth: p} = a.chart,
                    g = "left" === t.alignment, {x: u, y: f} = t, m = o.x;
                if (i.crookDistance) {
    ...
    let {getStartAndEndRadians: hY} = hN, {noop: hU} = w, {
        clamp: h$,
        extend: hV,
        fireEvent: hZ,
        merge: h_,
    ...
    class hK extends r1 {
        animate(t) {
            ...
            t || i.forEach(function (t) {
                ...
                i && o && (i.attr({r: hq(t.startR, e.center && e.center[3] / 2), start: s, end: s}), i.animate({
                    r: o.r,
                    start: o.start,
                    end: o.end
                }, e.options.animation))
        ...
        getX(t, e, i, s) {
            let o = this.center, r = this.radii ? this.radii[i.index] || 0 : o[2] / 2, a = s.dataLabelPosition,
                n = a?.distance || 0, h = Math.asin(h$((t - o[1]) / (r + n), -1, 1));
        ...
        translate(t) {
            ...
            let e = this.options, i = e.slicedOffset, s = hY(e.startAngle, e.endAngle),
                o = this.startAngleRad = s.start, r = (this.endAngleRad = s.end) - o, a = this.points,
                n = e.ignoreHiddenPoint, h = a.length, l, d, c, p, g, u, f, m = 0;
    ...
    let {composed: hJ, noop: hQ} = w, {distribute: h0} = ey, {series: h1} = rk, {
        arrayMax: h2,
        clamp: h3,
        defined: h5,
        pick: h6,
    ...
    !function (t) {
        ...
        function i(t, e) {
            ...
            let {center: a, options: n} = this, h = a[2] / 2, l = Math.cos(r), d = Math.sin(r), c = a[0] + l * h,
                p = a[1] + d * h, g = Math.min((n.slicedOffset || 0) + (n.borderWidth || 0), e / 5);
            return {
        ...
        function s() {
            let t = this, e = t.points, i = t.chart, s = i.plotWidth, o = i.plotHeight, r = i.plotLeft,
                a = Math.round(i.chartWidth / 3), n = t.center, h = n[2] / 2, l = n[1], d = [[], []], c = [0, 0, 0, 0],
            ...
            t.visible && t.hasDataLabels?.() && (e.forEach(t => {
                ...
                (t.dataLabels || []).forEach((e, i) => {
                    ...
                    0 === i && d[t.half].push(t), !h5(o?.style?.width) && e.getBBox().width > a && (e.css({width: Math.round(.7 * a) + "px"}), e.shortened = !0), e.dataLabelPosition = this.getDataLabelPosition(t, r), m = Math.max(m, r)
                })
            }), d.forEach((e, a) => {
                ...
                d && (t.sortByAngle(e, a - .5), m > 0 && (x = Math.max(0, l - h - m), y = Math.min(l + h + m, i.plotHeight), e.forEach(t => {
                    ...
                    (i.dataLabels || []).forEach(l => {
                        let d = l.options || {}, m = i.distributeBox, x = l.dataLabelPosition, y = x?.natural.y || 0,
                            b = d.connectorPadding || 0, v = l.lineHeight || 21, k = (v - l.getBBox().height) / 2,
                            w = 0, M = y, S = "inherit";
                        if (x) {
                ...
                (e.dataLabels || []).forEach(s => {
                    ...
                    if (r) {
                        ...
                        }), g[n ? "attr" : "animate"]({d: e.getConnectorPath(s)}), g.attr({visibility: a.attribs?.visibility})) : g && (s.connector = g.destroy())
                    }
                })
            })))
        }
    ...
    function la(t, e) {
        ...
        }), li(e, "afterHideOverlappingLabel")) : t.attr({opacity: i})), t.isOld = !0), s
    }
    ...
    function lb(t, e, i, s, o = {}) {
        ...
        for (; u--;) !function (t, e, i) {
            ...
            if ("Z" === n[0] && (n = t[0]), ("M" === a[0] || "L" === a[0]) && "A" === n[0] ? (s = a, o = n, r = !0) : "A" === a[0] && ("M" === n[0] || "L" === n[0]) && (s = n, o = a), s && o && o.params) {
                let a = o[1], n = o[5], h = o.params, {start: l, end: d, cx: c, cy: p} = h, g = n ? a - i : a + i,
                    u = g ? Math.asin(i / g) : 0, f = n ? u : -u, m = Math.cos(u) * g;
    ...
    function lv() {
        if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
            let {options: t, yAxis: e} = this, i = "percent" === t.stacking,
                s = ll.plotOptions?.[this.type]?.borderRadius, o = lk(t.borderRadius, lg(s) ? s : {}),
            ...
            for (let s of this.points) {
                ...
                if ("roundedRect" === s.shapeType && a) {
                    ...
                    "end" === g && (p && (d -= u), c += u), lp(a, {brBoxHeight: c, brBoxY: d, r: u})
                }
            }
        }
    }
    ...
    function lM(t, e, i, s, o = {}) {
        let r = ly(t, e, i, s, o), {r: a = 0, brBoxHeight: n = s, brBoxY: h = e} = o, l = e - h, d = h + n - (e + s),
            c = l - a > -.1 ? 0 : a, p = d - a > -.1 ? 0 : a, g = Math.max(c && l, 0), u = Math.max(p && d, 0),
            f = [t + c, e], m = [t + i - c, e], x = [t + i, e + c], y = [t + i, e + s - p], b = [t + i - p, e + s],
            v = [t + p, e + s], k = [t, e + s - p], w = [t, e + c],
    ...
    !function (t) {
        ...
        t.compose = function (t) {
            let s = t.prototype;
            return s.matchResponsiveRule || lT(s, {matchResponsiveRule: e, setResponsive: i}), t
        }
    }(b || (b = {}));
    let lO = b;
    w.AST = t6, w.Axis = s$, w.Chart = a0, w.Color = tL, w.DataLabel = hf, w.DataTableCore = rp, w.Fx = tB, w.HTMLElement = i6, w.Legend = au, w.LegendSymbol = rm, w.OverlappingDataLabels = w.OverlappingDataLabels || lh, w.PlotLineOrBand = oa, w.Point = oK, w.Pointer = ra, w.RendererRegistry = eg, w.Series = r1, w.SeriesRegistry = rk, w.StackItem = nd, w.SVGElement = eJ, w.SVGRenderer = iU, w.Templating = ep, w.Tick = sf, w.Time = tu, w.Tooltip = oE, w.animate = tU.animate, w.animObject = tU.animObject, w.chart = a0.chart, w.color = tL.parse, w.dateFormat = ep.dateFormat, w.defaultOptions = tv.defaultOptions, w.distribute = ey.distribute, w.format = ep.format, w.getDeferredAnimation = tU.getDeferredAnimation, w.getOptions = tv.getOptions, w.numberFormat = ep.numberFormat, w.seriesType = rk.seriesType, w.setAnimation = tU.setAnimation, w.setOptions = tv.setOptions, w.stop = tU.stop, w.time = tv.defaultTime, w.timers = tB.timers, ({
        compose: function (t, e, i) {
            ...
            if (!e.symbolCustomAttribs.includes("borderRadius")) {
                ...
                lc(t, "afterColumnTranslate", lv, {order: 9}), lc(s, "afterTranslate", lw), e.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY"), lx = o.arc, ly = o.roundedRect, o.arc = lb, o.roundedRect = lM
            }
        }, optionsToObject: lk
